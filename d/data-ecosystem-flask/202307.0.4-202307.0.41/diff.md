# Comparing `tmp/data_ecosystem_flask-202307.0.4.tar.gz` & `tmp/data_ecosystem_flask-202307.0.41.tar.gz`
...
## Comparing `data_ecosystem_flask-202307.0.4.tar` & `data_ecosystem_flask-202307.0.41.tar`
...
### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/Makefile.ps1` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/Makefile.ps1`

 * *Files identical despite different names*

### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/__init__.py` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/__init__.py`

 * *Files identical despite different names*

### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/app.py` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/app.py`
...
### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/app_startup.py` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/app_startup.py`
...
### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/install.py` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/install.py`

 * *Files identical despite different names*

### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/requirements.txt` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/requirements.txt`
...
### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/templates/download.html` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/templates/upload.html`
...
-      <p>Click the "Download" button below to Download a metadata file.</p>
...
+      <p>Click the "Upload" button below to upload a metadata file.</p>
       ...
       <div>
         <p>
-          <a
-          href="{{ url_for('metadata_excel_file_download', schema_id='106788') }}"
-          class="button"
-          target="_blank"
-          >Download</a>
-      </p>
...
@@ -1,6 +1,6 @@
-***** Download Metadata *****
-Click the "Download" button below to Download a metadata file.
+***** Upload Metadata *****
+Click the "Upload" button below to upload a metadata file.
 Please ensure the file follows the specified format and contains accurate
...
### Comparing `data_ecosystem_flask-202307.0.4/data_ecosystem_flask/templates/log_file.html` & `data_ecosystem_flask-202307.0.41/data_ecosystem_flask/templates/log_file.html`

 * *Files identical despite different names*

### Comparing `data_ecosystem_flask-202307.0.4/license.md` & `data_ecosystem_flask-202307.0.41/license.md`
...
### Comparing `data_ecosystem_flask-202307.0.4/pyproject.toml` & `data_ecosystem_flask-202307.0.41/pyproject.toml`
...
-certifi = "2023.5.7"
- 
+data-ecosystem-services = "^202307.0.41"
+
...
### Comparing `data_ecosystem_flask-202307.0.4/readme.md` & `data_ecosystem_flask-202307.0.41/readme.md`
...
### Comparing `data_ecosystem_flask-202307.0.4/PKG-INFO` & `data_ecosystem_flask-202307.0.41/PKG-INFO`
...
+Requires-Dist: data-ecosystem-services (>=202307.0.41,<202308.0.0)
