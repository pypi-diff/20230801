# Comparing `tmp/dagster-duckdb-polars-0.20.2.tar.gz` & `tmp/dagster-duckdb-polars-0.20.3.tar.gz`
...
## Comparing `dagster-duckdb-polars-0.20.2.tar` & `dagster-duckdb-polars-0.20.3.tar`
...
### Comparing `dagster-duckdb-polars-0.20.2/LICENSE` & `dagster-duckdb-polars-0.20.3/LICENSE`

 * *Files identical despite different names*

### Comparing `dagster-duckdb-polars-0.20.2/PKG-INFO` & `dagster-duckdb-polars-0.20.3/PKG-INFO`
...
### Comparing `dagster-duckdb-polars-0.20.2/dagster_duckdb_polars/duckdb_polars_type_handler.py` & `dagster-duckdb-polars-0.20.3/dagster_duckdb_polars/duckdb_polars_type_handler.py`

 * *Files identical despite different names*

### Comparing `dagster-duckdb-polars-0.20.2/dagster_duckdb_polars.egg-info/PKG-INFO` & `dagster-duckdb-polars-0.20.3/dagster_duckdb_polars.egg-info/PKG-INFO`
...
### Comparing `dagster-duckdb-polars-0.20.2/setup.py` & `dagster-duckdb-polars-0.20.3/setup.py`
