# Comparing `tmp/asana-4.0.0.tar.gz` & `tmp/asana-4.0.1.tar.gz`
...
### Comparing `asana-4.0.0/LICENSE` & `asana-4.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/PKG-INFO` & `asana-4.0.1/PKG-INFO`
...
### Comparing `asana-4.0.0/README.md` & `asana-4.0.1/README.md`
...
### Comparing `asana-4.0.0/asana/__init__.py` & `asana-4.0.1/asana/__init__.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/__init__.py` & `asana-4.0.1/asana/api/__init__.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/attachments_api.py` & `asana-4.0.1/asana/api/attachments_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/audit_log_api_api.py` & `asana-4.0.1/asana/api/audit_log_api_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/batch_api_api.py` & `asana-4.0.1/asana/api/batch_api_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/custom_field_settings_api.py` & `asana-4.0.1/asana/api/custom_field_settings_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/custom_fields_api.py` & `asana-4.0.1/asana/api/custom_fields_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/events_api.py` & `asana-4.0.1/asana/api/events_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/goal_relationships_api.py` & `asana-4.0.1/asana/api/goal_relationships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/goals_api.py` & `asana-4.0.1/asana/api/goals_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/jobs_api.py` & `asana-4.0.1/asana/api/jobs_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/memberships_api.py` & `asana-4.0.1/asana/api/memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/organization_exports_api.py` & `asana-4.0.1/asana/api/organization_exports_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/portfolio_memberships_api.py` & `asana-4.0.1/asana/api/portfolio_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/portfolios_api.py` & `asana-4.0.1/asana/api/portfolios_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/project_briefs_api.py` & `asana-4.0.1/asana/api/project_briefs_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/project_memberships_api.py` & `asana-4.0.1/asana/api/project_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/project_statuses_api.py` & `asana-4.0.1/asana/api/project_statuses_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/project_templates_api.py` & `asana-4.0.1/asana/api/project_templates_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/projects_api.py` & `asana-4.0.1/asana/api/projects_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/rules_api.py` & `asana-4.0.1/asana/api/rules_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/sections_api.py` & `asana-4.0.1/asana/api/sections_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/status_updates_api.py` & `asana-4.0.1/asana/api/status_updates_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/stories_api.py` & `asana-4.0.1/asana/api/stories_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/tags_api.py` & `asana-4.0.1/asana/api/tags_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/tasks_api.py` & `asana-4.0.1/asana/api/tasks_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/team_memberships_api.py` & `asana-4.0.1/asana/api/team_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/teams_api.py` & `asana-4.0.1/asana/api/teams_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/time_periods_api.py` & `asana-4.0.1/asana/api/time_periods_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/time_tracking_entries_api.py` & `asana-4.0.1/asana/api/time_tracking_entries_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/typeahead_api.py` & `asana-4.0.1/asana/api/typeahead_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/user_task_lists_api.py` & `asana-4.0.1/asana/api/user_task_lists_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/users_api.py` & `asana-4.0.1/asana/api/users_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/webhooks_api.py` & `asana-4.0.1/asana/api/webhooks_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/workspace_memberships_api.py` & `asana-4.0.1/asana/api/workspace_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api/workspaces_api.py` & `asana-4.0.1/asana/api/workspaces_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/api_client.py` & `asana-4.0.1/asana/api_client.py`
...
### Comparing `asana-4.0.0/asana/configuration.py` & `asana-4.0.1/asana/configuration.py`
...
### Comparing `asana-4.0.0/asana/models/__init__.py` & `asana-4.0.1/asana/models/__init__.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/add_custom_field_setting_request.py` & `asana-4.0.1/asana/models/add_custom_field_setting_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/add_followers_request.py` & `asana-4.0.1/asana/models/add_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/add_members_request.py` & `asana-4.0.1/asana/models/add_members_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_project_response_owner.py` & `asana-4.0.1/asana/models/all_of_project_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_project_template_base_owner.py` & `asana-4.0.1/asana/models/all_of_project_template_base_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_project_template_response_owner.py` & `asana-4.0.1/asana/models/all_of_project_template_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_story_response_new_date_value.py` & `asana-4.0.1/asana/models/all_of_story_response_new_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_story_response_old_date_value.py` & `asana-4.0.1/asana/models/all_of_story_response_old_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_base_owner.py` & `asana-4.0.1/asana/models/all_of_user_task_list_base_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_base_workspace.py` & `asana-4.0.1/asana/models/all_of_user_task_list_base_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_compact_owner.py` & `asana-4.0.1/asana/models/all_of_user_task_list_compact_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_compact_workspace.py` & `asana-4.0.1/asana/models/all_of_user_task_list_compact_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_request_owner.py` & `asana-4.0.1/asana/models/all_of_user_task_list_request_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_request_workspace.py` & `asana-4.0.1/asana/models/all_of_user_task_list_request_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_response_owner.py` & `asana-4.0.1/asana/models/all_of_user_task_list_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_user_task_list_response_workspace.py` & `asana-4.0.1/asana/models/all_of_user_task_list_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_workspace_membership_response_user_task_list_owner.py` & `asana-4.0.1/asana/models/all_of_workspace_membership_response_user_task_list_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/all_of_workspace_membership_response_user_task_list_workspace.py` & `asana-4.0.1/asana/models/all_of_workspace_membership_response_user_task_list_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/asana_named_resource.py` & `asana-4.0.1/asana/models/asana_named_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/asana_named_resource_array.py` & `asana-4.0.1/asana/models/asana_named_resource_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/asana_resource.py` & `asana-4.0.1/asana/models/asana_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_base.py` & `asana-4.0.1/asana/models/attachment_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_compact.py` & `asana-4.0.1/asana/models/attachment_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_request.py` & `asana-4.0.1/asana/models/attachment_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_response.py` & `asana-4.0.1/asana/models/attachment_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_response_array.py` & `asana-4.0.1/asana/models/attachment_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_response_data.py` & `asana-4.0.1/asana/models/attachment_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/attachment_response_parent.py` & `asana-4.0.1/asana/models/attachment_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event.py` & `asana-4.0.1/asana/models/audit_log_event.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event_actor.py` & `asana-4.0.1/asana/models/audit_log_event_actor.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event_array.py` & `asana-4.0.1/asana/models/audit_log_event_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event_context.py` & `asana-4.0.1/asana/models/audit_log_event_context.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event_details.py` & `asana-4.0.1/asana/models/audit_log_event_details.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/audit_log_event_resource.py` & `asana-4.0.1/asana/models/audit_log_event_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_body.py` & `asana-4.0.1/asana/models/batch_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_request.py` & `asana-4.0.1/asana/models/batch_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_request_action.py` & `asana-4.0.1/asana/models/batch_request_action.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_request_actions.py` & `asana-4.0.1/asana/models/batch_request_actions.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_request_options.py` & `asana-4.0.1/asana/models/batch_request_options.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_response.py` & `asana-4.0.1/asana/models/batch_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/batch_response_array.py` & `asana-4.0.1/asana/models/batch_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/create_membership_request.py` & `asana-4.0.1/asana/models/create_membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/create_time_tracking_entry_request.py` & `asana-4.0.1/asana/models/create_time_tracking_entry_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_base.py` & `asana-4.0.1/asana/models/custom_field_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_base_date_value.py` & `asana-4.0.1/asana/models/custom_field_base_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_base_enum_options.py` & `asana-4.0.1/asana/models/custom_field_base_enum_options.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_base_enum_value.py` & `asana-4.0.1/asana/models/custom_field_base_enum_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_compact.py` & `asana-4.0.1/asana/models/custom_field_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_gid_enum_options_body.py` & `asana-4.0.1/asana/models/custom_field_gid_enum_options_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_request.py` & `asana-4.0.1/asana/models/custom_field_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_response.py` & `asana-4.0.1/asana/models/custom_field_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_response_array.py` & `asana-4.0.1/asana/models/custom_field_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_response_created_by.py` & `asana-4.0.1/asana/models/custom_field_response_created_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_response_data.py` & `asana-4.0.1/asana/models/custom_field_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_response_people_value.py` & `asana-4.0.1/asana/models/custom_field_response_people_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_base.py` & `asana-4.0.1/asana/models/custom_field_setting_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_compact.py` & `asana-4.0.1/asana/models/custom_field_setting_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response.py` & `asana-4.0.1/asana/models/custom_field_setting_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response_array.py` & `asana-4.0.1/asana/models/custom_field_setting_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response_custom_field.py` & `asana-4.0.1/asana/models/custom_field_setting_response_custom_field.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response_data.py` & `asana-4.0.1/asana/models/custom_field_setting_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response_parent.py` & `asana-4.0.1/asana/models/custom_field_setting_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_field_setting_response_project.py` & `asana-4.0.1/asana/models/custom_field_setting_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_fields_body.py` & `asana-4.0.1/asana/models/custom_fields_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/custom_fields_custom_field_gid_body.py` & `asana-4.0.1/asana/models/custom_fields_custom_field_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/date_variable_compact.py` & `asana-4.0.1/asana/models/date_variable_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/date_variable_request.py` & `asana-4.0.1/asana/models/date_variable_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/empty_response.py` & `asana-4.0.1/asana/models/empty_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/empty_response_data.py` & `asana-4.0.1/asana/models/empty_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_option.py` & `asana-4.0.1/asana/models/enum_option.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_option_base.py` & `asana-4.0.1/asana/models/enum_option_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_option_data.py` & `asana-4.0.1/asana/models/enum_option_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_option_insert_request.py` & `asana-4.0.1/asana/models/enum_option_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_option_request.py` & `asana-4.0.1/asana/models/enum_option_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_options_enum_option_gid_body.py` & `asana-4.0.1/asana/models/enum_options_enum_option_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/enum_options_insert_body.py` & `asana-4.0.1/asana/models/enum_options_insert_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/error.py` & `asana-4.0.1/asana/models/error.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/error_response.py` & `asana-4.0.1/asana/models/error_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/error_response_errors.py` & `asana-4.0.1/asana/models/error_response_errors.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response.py` & `asana-4.0.1/asana/models/event_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response_array.py` & `asana-4.0.1/asana/models/event_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response_change.py` & `asana-4.0.1/asana/models/event_response_change.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response_parent.py` & `asana-4.0.1/asana/models/event_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response_resource.py` & `asana-4.0.1/asana/models/event_response_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/event_response_user.py` & `asana-4.0.1/asana/models/event_response_user.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_add_subgoal_request.py` & `asana-4.0.1/asana/models/goal_add_subgoal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_add_supporting_relationship_request.py` & `asana-4.0.1/asana/models/goal_add_supporting_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_add_supporting_work_request.py` & `asana-4.0.1/asana/models/goal_add_supporting_work_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_base.py` & `asana-4.0.1/asana/models/goal_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_compact.py` & `asana-4.0.1/asana/models/goal_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_add_followers_body.py` & `asana-4.0.1/asana/models/goal_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_add_supporting_relationship_body.py` & `asana-4.0.1/asana/models/goal_gid_add_supporting_relationship_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_remove_followers_body.py` & `asana-4.0.1/asana/models/goal_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_remove_supporting_relationship_body.py` & `asana-4.0.1/asana/models/goal_gid_remove_supporting_relationship_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_set_metric_body.py` & `asana-4.0.1/asana/models/goal_gid_set_metric_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_gid_set_metric_current_value_body.py` & `asana-4.0.1/asana/models/goal_gid_set_metric_current_value_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_membership_base.py` & `asana-4.0.1/asana/models/goal_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_membership_base_goal.py` & `asana-4.0.1/asana/models/goal_membership_base_goal.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_membership_compact.py` & `asana-4.0.1/asana/models/goal_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_membership_response.py` & `asana-4.0.1/asana/models/goal_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_metric_base.py` & `asana-4.0.1/asana/models/goal_metric_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_metric_current_value_request.py` & `asana-4.0.1/asana/models/goal_metric_current_value_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_metric_request.py` & `asana-4.0.1/asana/models/goal_metric_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_base.py` & `asana-4.0.1/asana/models/goal_relationship_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_base_supported_goal.py` & `asana-4.0.1/asana/models/goal_relationship_base_supported_goal.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_base_supporting_resource.py` & `asana-4.0.1/asana/models/goal_relationship_base_supporting_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_compact.py` & `asana-4.0.1/asana/models/goal_relationship_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_request.py` & `asana-4.0.1/asana/models/goal_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_response.py` & `asana-4.0.1/asana/models/goal_relationship_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_response_array.py` & `asana-4.0.1/asana/models/goal_relationship_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationship_response_data.py` & `asana-4.0.1/asana/models/goal_relationship_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_relationships_goal_relationship_gid_body.py` & `asana-4.0.1/asana/models/goal_relationships_goal_relationship_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_remove_subgoal_request.py` & `asana-4.0.1/asana/models/goal_remove_subgoal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_remove_supporting_relationship_request.py` & `asana-4.0.1/asana/models/goal_remove_supporting_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_request.py` & `asana-4.0.1/asana/models/goal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_request_base.py` & `asana-4.0.1/asana/models/goal_request_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response.py` & `asana-4.0.1/asana/models/goal_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_array.py` & `asana-4.0.1/asana/models/goal_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_current_status_update.py` & `asana-4.0.1/asana/models/goal_response_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_data.py` & `asana-4.0.1/asana/models/goal_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_likes.py` & `asana-4.0.1/asana/models/goal_response_likes.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_metric.py` & `asana-4.0.1/asana/models/goal_response_metric.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_team.py` & `asana-4.0.1/asana/models/goal_response_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_time_period.py` & `asana-4.0.1/asana/models/goal_response_time_period.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_response_workspace.py` & `asana-4.0.1/asana/models/goal_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goal_update_request.py` & `asana-4.0.1/asana/models/goal_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goals_body.py` & `asana-4.0.1/asana/models/goals_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/goals_goal_gid_body.py` & `asana-4.0.1/asana/models/goals_goal_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/inline_response412.py` & `asana-4.0.1/asana/models/inline_response412.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/inline_response412_errors.py` & `asana-4.0.1/asana/models/inline_response412_errors.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_base.py` & `asana-4.0.1/asana/models/job_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_base_new_project.py` & `asana-4.0.1/asana/models/job_base_new_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_base_new_project_template.py` & `asana-4.0.1/asana/models/job_base_new_project_template.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_base_new_task.py` & `asana-4.0.1/asana/models/job_base_new_task.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_compact.py` & `asana-4.0.1/asana/models/job_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_response.py` & `asana-4.0.1/asana/models/job_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/job_response_data.py` & `asana-4.0.1/asana/models/job_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/like.py` & `asana-4.0.1/asana/models/like.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/member_compact.py` & `asana-4.0.1/asana/models/member_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/membership_request.py` & `asana-4.0.1/asana/models/membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/membership_response.py` & `asana-4.0.1/asana/models/membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/membership_response_array.py` & `asana-4.0.1/asana/models/membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/membership_response_data.py` & `asana-4.0.1/asana/models/membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/memberships_body.py` & `asana-4.0.1/asana/models/memberships_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/modify_dependencies_request.py` & `asana-4.0.1/asana/models/modify_dependencies_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/modify_dependents_request.py` & `asana-4.0.1/asana/models/modify_dependents_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/next_page.py` & `asana-4.0.1/asana/models/next_page.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_export_base.py` & `asana-4.0.1/asana/models/organization_export_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_export_compact.py` & `asana-4.0.1/asana/models/organization_export_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_export_request.py` & `asana-4.0.1/asana/models/organization_export_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_export_response.py` & `asana-4.0.1/asana/models/organization_export_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_export_response_data.py` & `asana-4.0.1/asana/models/organization_export_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/organization_exports_body.py` & `asana-4.0.1/asana/models/organization_exports_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_add_item_request.py` & `asana-4.0.1/asana/models/portfolio_add_item_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_base.py` & `asana-4.0.1/asana/models/portfolio_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_compact.py` & `asana-4.0.1/asana/models/portfolio_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_add_custom_field_setting_body.py` & `asana-4.0.1/asana/models/portfolio_gid_add_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_add_item_body.py` & `asana-4.0.1/asana/models/portfolio_gid_add_item_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_add_members_body.py` & `asana-4.0.1/asana/models/portfolio_gid_add_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_remove_custom_field_setting_body.py` & `asana-4.0.1/asana/models/portfolio_gid_remove_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_remove_item_body.py` & `asana-4.0.1/asana/models/portfolio_gid_remove_item_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_gid_remove_members_body.py` & `asana-4.0.1/asana/models/portfolio_gid_remove_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_base.py` & `asana-4.0.1/asana/models/portfolio_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_base_portfolio.py` & `asana-4.0.1/asana/models/portfolio_membership_base_portfolio.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_compact.py` & `asana-4.0.1/asana/models/portfolio_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_response.py` & `asana-4.0.1/asana/models/portfolio_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_response_array.py` & `asana-4.0.1/asana/models/portfolio_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_membership_response_data.py` & `asana-4.0.1/asana/models/portfolio_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_remove_item_request.py` & `asana-4.0.1/asana/models/portfolio_remove_item_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_request.py` & `asana-4.0.1/asana/models/portfolio_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response.py` & `asana-4.0.1/asana/models/portfolio_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_array.py` & `asana-4.0.1/asana/models/portfolio_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_current_status_update.py` & `asana-4.0.1/asana/models/portfolio_response_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_custom_field_settings.py` & `asana-4.0.1/asana/models/portfolio_response_custom_field_settings.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_custom_fields.py` & `asana-4.0.1/asana/models/portfolio_response_custom_fields.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_data.py` & `asana-4.0.1/asana/models/portfolio_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolio_response_workspace.py` & `asana-4.0.1/asana/models/portfolio_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolios_body.py` & `asana-4.0.1/asana/models/portfolios_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/portfolios_portfolio_gid_body.py` & `asana-4.0.1/asana/models/portfolios_portfolio_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/preview.py` & `asana-4.0.1/asana/models/preview.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_base.py` & `asana-4.0.1/asana/models/project_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_base_current_status.py` & `asana-4.0.1/asana/models/project_base_current_status.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_base_current_status_update.py` & `asana-4.0.1/asana/models/project_base_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_base_workspace.py` & `asana-4.0.1/asana/models/project_base_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_base.py` & `asana-4.0.1/asana/models/project_brief_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_compact.py` & `asana-4.0.1/asana/models/project_brief_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_request.py` & `asana-4.0.1/asana/models/project_brief_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_response.py` & `asana-4.0.1/asana/models/project_brief_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_response_data.py` & `asana-4.0.1/asana/models/project_brief_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_brief_response_project.py` & `asana-4.0.1/asana/models/project_brief_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_briefs_project_brief_gid_body.py` & `asana-4.0.1/asana/models/project_briefs_project_brief_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_compact.py` & `asana-4.0.1/asana/models/project_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_duplicate_request.py` & `asana-4.0.1/asana/models/project_duplicate_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_duplicate_request_schedule_dates.py` & `asana-4.0.1/asana/models/project_duplicate_request_schedule_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_add_custom_field_setting_body.py` & `asana-4.0.1/asana/models/project_gid_add_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_add_followers_body.py` & `asana-4.0.1/asana/models/project_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_add_members_body.py` & `asana-4.0.1/asana/models/project_gid_add_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_duplicate_body.py` & `asana-4.0.1/asana/models/project_gid_duplicate_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_project_briefs_body.py` & `asana-4.0.1/asana/models/project_gid_project_briefs_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_project_statuses_body.py` & `asana-4.0.1/asana/models/project_gid_project_statuses_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_remove_custom_field_setting_body.py` & `asana-4.0.1/asana/models/project_gid_remove_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_remove_followers_body.py` & `asana-4.0.1/asana/models/project_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_remove_members_body.py` & `asana-4.0.1/asana/models/project_gid_remove_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_save_as_template_body.py` & `asana-4.0.1/asana/models/project_gid_save_as_template_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_gid_sections_body.py` & `asana-4.0.1/asana/models/project_gid_sections_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_base.py` & `asana-4.0.1/asana/models/project_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_compact.py` & `asana-4.0.1/asana/models/project_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_response.py` & `asana-4.0.1/asana/models/project_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_response_array.py` & `asana-4.0.1/asana/models/project_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_response_data.py` & `asana-4.0.1/asana/models/project_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_membership_response_member.py` & `asana-4.0.1/asana/models/project_membership_response_member.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_request.py` & `asana-4.0.1/asana/models/project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response.py` & `asana-4.0.1/asana/models/project_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_array.py` & `asana-4.0.1/asana/models/project_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_completed_by.py` & `asana-4.0.1/asana/models/project_response_completed_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_created_from_template.py` & `asana-4.0.1/asana/models/project_response_created_from_template.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_data.py` & `asana-4.0.1/asana/models/project_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_project_brief.py` & `asana-4.0.1/asana/models/project_response_project_brief.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_response_team.py` & `asana-4.0.1/asana/models/project_response_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_save_as_template_request.py` & `asana-4.0.1/asana/models/project_save_as_template_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_section_insert_request.py` & `asana-4.0.1/asana/models/project_section_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_base.py` & `asana-4.0.1/asana/models/project_status_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_compact.py` & `asana-4.0.1/asana/models/project_status_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_request.py` & `asana-4.0.1/asana/models/project_status_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_response.py` & `asana-4.0.1/asana/models/project_status_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_response_array.py` & `asana-4.0.1/asana/models/project_status_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_status_response_data.py` & `asana-4.0.1/asana/models/project_status_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_base.py` & `asana-4.0.1/asana/models/project_template_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_base_requested_dates.py` & `asana-4.0.1/asana/models/project_template_base_requested_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_base_requested_roles.py` & `asana-4.0.1/asana/models/project_template_base_requested_roles.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_base_team.py` & `asana-4.0.1/asana/models/project_template_base_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_compact.py` & `asana-4.0.1/asana/models/project_template_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_gid_instantiate_project_body.py` & `asana-4.0.1/asana/models/project_template_gid_instantiate_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_instantiate_project_request.py` & `asana-4.0.1/asana/models/project_template_instantiate_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_instantiate_project_request_requested_dates.py` & `asana-4.0.1/asana/models/project_template_instantiate_project_request_requested_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_instantiate_project_request_requested_roles.py` & `asana-4.0.1/asana/models/project_template_instantiate_project_request_requested_roles.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_response.py` & `asana-4.0.1/asana/models/project_template_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_response_array.py` & `asana-4.0.1/asana/models/project_template_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/project_template_response_data.py` & `asana-4.0.1/asana/models/project_template_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/projects_body.py` & `asana-4.0.1/asana/models/projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/projects_project_gid_body.py` & `asana-4.0.1/asana/models/projects_project_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/remove_custom_field_setting_request.py` & `asana-4.0.1/asana/models/remove_custom_field_setting_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/remove_followers_request.py` & `asana-4.0.1/asana/models/remove_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/remove_members_request.py` & `asana-4.0.1/asana/models/remove_members_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/requested_role_request.py` & `asana-4.0.1/asana/models/requested_role_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/rule_trigger_gid_run_body.py` & `asana-4.0.1/asana/models/rule_trigger_gid_run_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/rule_trigger_request.py` & `asana-4.0.1/asana/models/rule_trigger_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/rule_trigger_response.py` & `asana-4.0.1/asana/models/rule_trigger_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/rule_trigger_response_data.py` & `asana-4.0.1/asana/models/rule_trigger_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_base.py` & `asana-4.0.1/asana/models/section_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_compact.py` & `asana-4.0.1/asana/models/section_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_gid_add_task_body.py` & `asana-4.0.1/asana/models/section_gid_add_task_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_request.py` & `asana-4.0.1/asana/models/section_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_response.py` & `asana-4.0.1/asana/models/section_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_response_array.py` & `asana-4.0.1/asana/models/section_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_response_data.py` & `asana-4.0.1/asana/models/section_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/section_task_insert_request.py` & `asana-4.0.1/asana/models/section_task_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/sections_insert_body.py` & `asana-4.0.1/asana/models/sections_insert_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/sections_section_gid_body.py` & `asana-4.0.1/asana/models/sections_section_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_base.py` & `asana-4.0.1/asana/models/status_update_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_compact.py` & `asana-4.0.1/asana/models/status_update_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_request.py` & `asana-4.0.1/asana/models/status_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_response.py` & `asana-4.0.1/asana/models/status_update_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_response_array.py` & `asana-4.0.1/asana/models/status_update_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_response_data.py` & `asana-4.0.1/asana/models/status_update_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_update_response_parent.py` & `asana-4.0.1/asana/models/status_update_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/status_updates_body.py` & `asana-4.0.1/asana/models/status_updates_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/stories_story_gid_body.py` & `asana-4.0.1/asana/models/stories_story_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_base.py` & `asana-4.0.1/asana/models/story_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_compact.py` & `asana-4.0.1/asana/models/story_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_request.py` & `asana-4.0.1/asana/models/story_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response.py` & `asana-4.0.1/asana/models/story_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_array.py` & `asana-4.0.1/asana/models/story_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_assignee.py` & `asana-4.0.1/asana/models/story_response_assignee.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_custom_field.py` & `asana-4.0.1/asana/models/story_response_custom_field.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_data.py` & `asana-4.0.1/asana/models/story_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_dates.py` & `asana-4.0.1/asana/models/story_response_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_old_dates.py` & `asana-4.0.1/asana/models/story_response_old_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_old_enum_value.py` & `asana-4.0.1/asana/models/story_response_old_enum_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_old_section.py` & `asana-4.0.1/asana/models/story_response_old_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_previews.py` & `asana-4.0.1/asana/models/story_response_previews.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_project.py` & `asana-4.0.1/asana/models/story_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_story.py` & `asana-4.0.1/asana/models/story_response_story.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_tag.py` & `asana-4.0.1/asana/models/story_response_tag.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_target.py` & `asana-4.0.1/asana/models/story_response_target.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/story_response_task.py` & `asana-4.0.1/asana/models/story_response_task.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_base.py` & `asana-4.0.1/asana/models/tag_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_compact.py` & `asana-4.0.1/asana/models/tag_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_request.py` & `asana-4.0.1/asana/models/tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_response.py` & `asana-4.0.1/asana/models/tag_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_response_array.py` & `asana-4.0.1/asana/models/tag_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tag_response_data.py` & `asana-4.0.1/asana/models/tag_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tags_body.py` & `asana-4.0.1/asana/models/tags_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_add_followers_request.py` & `asana-4.0.1/asana/models/task_add_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_add_project_request.py` & `asana-4.0.1/asana/models/task_add_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_add_tag_request.py` & `asana-4.0.1/asana/models/task_add_tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base.py` & `asana-4.0.1/asana/models/task_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base_completed_by.py` & `asana-4.0.1/asana/models/task_base_completed_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base_dependencies.py` & `asana-4.0.1/asana/models/task_base_dependencies.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base_external.py` & `asana-4.0.1/asana/models/task_base_external.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base_memberships.py` & `asana-4.0.1/asana/models/task_base_memberships.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_base_section.py` & `asana-4.0.1/asana/models/task_base_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_compact.py` & `asana-4.0.1/asana/models/task_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_count_response.py` & `asana-4.0.1/asana/models/task_count_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_count_response_data.py` & `asana-4.0.1/asana/models/task_count_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_duplicate_request.py` & `asana-4.0.1/asana/models/task_duplicate_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_add_dependencies_body.py` & `asana-4.0.1/asana/models/task_gid_add_dependencies_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_add_dependents_body.py` & `asana-4.0.1/asana/models/task_gid_add_dependents_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_add_followers_body.py` & `asana-4.0.1/asana/models/task_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_add_project_body.py` & `asana-4.0.1/asana/models/task_gid_add_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_add_tag_body.py` & `asana-4.0.1/asana/models/task_gid_add_tag_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_duplicate_body.py` & `asana-4.0.1/asana/models/task_gid_duplicate_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_remove_dependencies_body.py` & `asana-4.0.1/asana/models/task_gid_remove_dependencies_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_remove_dependents_body.py` & `asana-4.0.1/asana/models/task_gid_remove_dependents_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_remove_followers_body.py` & `asana-4.0.1/asana/models/task_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_remove_project_body.py` & `asana-4.0.1/asana/models/task_gid_remove_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_remove_tag_body.py` & `asana-4.0.1/asana/models/task_gid_remove_tag_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_set_parent_body.py` & `asana-4.0.1/asana/models/task_gid_set_parent_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_stories_body.py` & `asana-4.0.1/asana/models/task_gid_stories_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_subtasks_body.py` & `asana-4.0.1/asana/models/task_gid_subtasks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_gid_time_tracking_entries_body.py` & `asana-4.0.1/asana/models/task_gid_time_tracking_entries_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_remove_followers_request.py` & `asana-4.0.1/asana/models/task_remove_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_remove_project_request.py` & `asana-4.0.1/asana/models/task_remove_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_remove_tag_request.py` & `asana-4.0.1/asana/models/task_remove_tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_request.py` & `asana-4.0.1/asana/models/task_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response.py` & `asana-4.0.1/asana/models/task_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_array.py` & `asana-4.0.1/asana/models/task_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_assignee_section.py` & `asana-4.0.1/asana/models/task_response_assignee_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_custom_fields.py` & `asana-4.0.1/asana/models/task_response_custom_fields.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_data.py` & `asana-4.0.1/asana/models/task_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_parent.py` & `asana-4.0.1/asana/models/task_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_tags.py` & `asana-4.0.1/asana/models/task_response_tags.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_response_workspace.py` & `asana-4.0.1/asana/models/task_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/task_set_parent_request.py` & `asana-4.0.1/asana/models/task_set_parent_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tasks_body.py` & `asana-4.0.1/asana/models/tasks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/tasks_task_gid_body.py` & `asana-4.0.1/asana/models/tasks_task_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_add_user_request.py` & `asana-4.0.1/asana/models/team_add_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_base.py` & `asana-4.0.1/asana/models/team_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_compact.py` & `asana-4.0.1/asana/models/team_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_gid_add_user_body.py` & `asana-4.0.1/asana/models/team_gid_add_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_gid_projects_body.py` & `asana-4.0.1/asana/models/team_gid_projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_gid_remove_user_body.py` & `asana-4.0.1/asana/models/team_gid_remove_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_membership_base.py` & `asana-4.0.1/asana/models/team_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_membership_compact.py` & `asana-4.0.1/asana/models/team_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_membership_response.py` & `asana-4.0.1/asana/models/team_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_membership_response_array.py` & `asana-4.0.1/asana/models/team_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_membership_response_data.py` & `asana-4.0.1/asana/models/team_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_remove_user_request.py` & `asana-4.0.1/asana/models/team_remove_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_request.py` & `asana-4.0.1/asana/models/team_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_response.py` & `asana-4.0.1/asana/models/team_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_response_array.py` & `asana-4.0.1/asana/models/team_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_response_data.py` & `asana-4.0.1/asana/models/team_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/team_response_organization.py` & `asana-4.0.1/asana/models/team_response_organization.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/teams_body.py` & `asana-4.0.1/asana/models/teams_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/teams_team_gid_body.py` & `asana-4.0.1/asana/models/teams_team_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/template_role.py` & `asana-4.0.1/asana/models/template_role.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_period_base.py` & `asana-4.0.1/asana/models/time_period_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_period_compact.py` & `asana-4.0.1/asana/models/time_period_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_period_response.py` & `asana-4.0.1/asana/models/time_period_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_period_response_array.py` & `asana-4.0.1/asana/models/time_period_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_period_response_data.py` & `asana-4.0.1/asana/models/time_period_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_tracking_entries_time_tracking_entry_gid_body.py` & `asana-4.0.1/asana/models/time_tracking_entries_time_tracking_entry_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_tracking_entry_base.py` & `asana-4.0.1/asana/models/time_tracking_entry_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_tracking_entry_base_data.py` & `asana-4.0.1/asana/models/time_tracking_entry_base_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_tracking_entry_compact.py` & `asana-4.0.1/asana/models/time_tracking_entry_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/time_tracking_entry_compact_array.py` & `asana-4.0.1/asana/models/time_tracking_entry_compact_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/update_time_tracking_entry_request.py` & `asana-4.0.1/asana/models/update_time_tracking_entry_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_base.py` & `asana-4.0.1/asana/models/user_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_base_response.py` & `asana-4.0.1/asana/models/user_base_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_base_response_data.py` & `asana-4.0.1/asana/models/user_base_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_base_response_photo.py` & `asana-4.0.1/asana/models/user_base_response_photo.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_compact.py` & `asana-4.0.1/asana/models/user_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_request.py` & `asana-4.0.1/asana/models/user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_response.py` & `asana-4.0.1/asana/models/user_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_response_array.py` & `asana-4.0.1/asana/models/user_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_response_data.py` & `asana-4.0.1/asana/models/user_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_task_list_base.py` & `asana-4.0.1/asana/models/user_task_list_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_task_list_compact.py` & `asana-4.0.1/asana/models/user_task_list_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_task_list_request.py` & `asana-4.0.1/asana/models/user_task_list_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_task_list_response.py` & `asana-4.0.1/asana/models/user_task_list_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/user_task_list_response_data.py` & `asana-4.0.1/asana/models/user_task_list_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_compact.py` & `asana-4.0.1/asana/models/webhook_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_compact_resource.py` & `asana-4.0.1/asana/models/webhook_compact_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_filter.py` & `asana-4.0.1/asana/models/webhook_filter.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_request.py` & `asana-4.0.1/asana/models/webhook_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_request_filters.py` & `asana-4.0.1/asana/models/webhook_request_filters.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_response.py` & `asana-4.0.1/asana/models/webhook_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_response_array.py` & `asana-4.0.1/asana/models/webhook_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_response_data.py` & `asana-4.0.1/asana/models/webhook_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhook_update_request.py` & `asana-4.0.1/asana/models/webhook_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhooks_body.py` & `asana-4.0.1/asana/models/webhooks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/webhooks_webhook_gid_body.py` & `asana-4.0.1/asana/models/webhooks_webhook_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_add_user_request.py` & `asana-4.0.1/asana/models/workspace_add_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_base.py` & `asana-4.0.1/asana/models/workspace_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_compact.py` & `asana-4.0.1/asana/models/workspace_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_gid_add_user_body.py` & `asana-4.0.1/asana/models/workspace_gid_add_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_gid_projects_body.py` & `asana-4.0.1/asana/models/workspace_gid_projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_gid_remove_user_body.py` & `asana-4.0.1/asana/models/workspace_gid_remove_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_gid_tags_body.py` & `asana-4.0.1/asana/models/workspace_gid_tags_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_base.py` & `asana-4.0.1/asana/models/workspace_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_compact.py` & `asana-4.0.1/asana/models/workspace_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_request.py` & `asana-4.0.1/asana/models/workspace_membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_response.py` & `asana-4.0.1/asana/models/workspace_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_response_array.py` & `asana-4.0.1/asana/models/workspace_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_response_data.py` & `asana-4.0.1/asana/models/workspace_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_response_user_task_list.py` & `asana-4.0.1/asana/models/workspace_membership_response_user_task_list.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_membership_response_vacation_dates.py` & `asana-4.0.1/asana/models/workspace_membership_response_vacation_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_remove_user_request.py` & `asana-4.0.1/asana/models/workspace_remove_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_request.py` & `asana-4.0.1/asana/models/workspace_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_response.py` & `asana-4.0.1/asana/models/workspace_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_response_array.py` & `asana-4.0.1/asana/models/workspace_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspace_response_data.py` & `asana-4.0.1/asana/models/workspace_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/models/workspaces_workspace_gid_body.py` & `asana-4.0.1/asana/models/workspaces_workspace_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana/rest.py` & `asana-4.0.1/asana/rest.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/asana.egg-info/PKG-INFO` & `asana-4.0.1/asana.egg-info/PKG-INFO`
...
### Comparing `asana-4.0.0/asana.egg-info/SOURCES.txt` & `asana-4.0.1/asana.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/setup.py` & `asana-4.0.1/setup.py`
...
### Comparing `asana-4.0.0/test/test_add_custom_field_setting_request.py` & `asana-4.0.1/test/test_add_custom_field_setting_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_add_followers_request.py` & `asana-4.0.1/test/test_add_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_add_members_request.py` & `asana-4.0.1/test/test_add_members_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_project_response_owner.py` & `asana-4.0.1/test/test_all_of_project_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_project_template_base_owner.py` & `asana-4.0.1/test/test_all_of_project_template_base_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_project_template_response_owner.py` & `asana-4.0.1/test/test_all_of_project_template_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_story_response_new_date_value.py` & `asana-4.0.1/test/test_all_of_story_response_new_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_story_response_old_date_value.py` & `asana-4.0.1/test/test_all_of_story_response_old_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_base_owner.py` & `asana-4.0.1/test/test_all_of_user_task_list_base_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_base_workspace.py` & `asana-4.0.1/test/test_all_of_user_task_list_base_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_compact_owner.py` & `asana-4.0.1/test/test_all_of_user_task_list_compact_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_compact_workspace.py` & `asana-4.0.1/test/test_all_of_user_task_list_compact_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_request_owner.py` & `asana-4.0.1/test/test_all_of_user_task_list_request_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_request_workspace.py` & `asana-4.0.1/test/test_all_of_user_task_list_request_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_response_owner.py` & `asana-4.0.1/test/test_all_of_user_task_list_response_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_user_task_list_response_workspace.py` & `asana-4.0.1/test/test_all_of_user_task_list_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_workspace_membership_response_user_task_list_owner.py` & `asana-4.0.1/test/test_all_of_workspace_membership_response_user_task_list_owner.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_all_of_workspace_membership_response_user_task_list_workspace.py` & `asana-4.0.1/test/test_all_of_workspace_membership_response_user_task_list_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_asana_named_resource.py` & `asana-4.0.1/test/test_asana_named_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_asana_named_resource_array.py` & `asana-4.0.1/test/test_asana_named_resource_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_asana_resource.py` & `asana-4.0.1/test/test_asana_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_base.py` & `asana-4.0.1/test/test_attachment_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_compact.py` & `asana-4.0.1/test/test_attachment_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_request.py` & `asana-4.0.1/test/test_attachment_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_response.py` & `asana-4.0.1/test/test_attachment_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_response_array.py` & `asana-4.0.1/test/test_attachment_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_response_data.py` & `asana-4.0.1/test/test_attachment_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachment_response_parent.py` & `asana-4.0.1/test/test_attachment_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_attachments_api.py` & `asana-4.0.1/test/test_attachments_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_api_api.py` & `asana-4.0.1/test/test_audit_log_api_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event.py` & `asana-4.0.1/test/test_audit_log_event.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event_actor.py` & `asana-4.0.1/test/test_audit_log_event_actor.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event_array.py` & `asana-4.0.1/test/test_audit_log_event_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event_context.py` & `asana-4.0.1/test/test_audit_log_event_context.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event_details.py` & `asana-4.0.1/test/test_audit_log_event_details.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_audit_log_event_resource.py` & `asana-4.0.1/test/test_audit_log_event_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_api_api.py` & `asana-4.0.1/test/test_batch_api_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_body.py` & `asana-4.0.1/test/test_batch_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_request.py` & `asana-4.0.1/test/test_batch_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_request_action.py` & `asana-4.0.1/test/test_batch_request_action.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_request_actions.py` & `asana-4.0.1/test/test_batch_request_actions.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_request_options.py` & `asana-4.0.1/test/test_batch_request_options.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_response.py` & `asana-4.0.1/test/test_batch_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_batch_response_array.py` & `asana-4.0.1/test/test_batch_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_create_membership_request.py` & `asana-4.0.1/test/test_create_membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_create_time_tracking_entry_request.py` & `asana-4.0.1/test/test_create_time_tracking_entry_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_base.py` & `asana-4.0.1/test/test_custom_field_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_base_date_value.py` & `asana-4.0.1/test/test_custom_field_base_date_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_base_enum_options.py` & `asana-4.0.1/test/test_custom_field_base_enum_options.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_base_enum_value.py` & `asana-4.0.1/test/test_custom_field_base_enum_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_compact.py` & `asana-4.0.1/test/test_custom_field_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_gid_enum_options_body.py` & `asana-4.0.1/test/test_custom_field_gid_enum_options_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_request.py` & `asana-4.0.1/test/test_custom_field_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_response.py` & `asana-4.0.1/test/test_custom_field_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_response_array.py` & `asana-4.0.1/test/test_custom_field_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_response_created_by.py` & `asana-4.0.1/test/test_custom_field_response_created_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_response_data.py` & `asana-4.0.1/test/test_custom_field_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_response_people_value.py` & `asana-4.0.1/test/test_custom_field_response_people_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_base.py` & `asana-4.0.1/test/test_custom_field_setting_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_compact.py` & `asana-4.0.1/test/test_custom_field_setting_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response.py` & `asana-4.0.1/test/test_custom_field_setting_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response_array.py` & `asana-4.0.1/test/test_custom_field_setting_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response_custom_field.py` & `asana-4.0.1/test/test_custom_field_setting_response_custom_field.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response_data.py` & `asana-4.0.1/test/test_custom_field_setting_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response_parent.py` & `asana-4.0.1/test/test_custom_field_setting_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_setting_response_project.py` & `asana-4.0.1/test/test_custom_field_setting_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_field_settings_api.py` & `asana-4.0.1/test/test_custom_field_settings_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_fields_api.py` & `asana-4.0.1/test/test_custom_fields_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_fields_body.py` & `asana-4.0.1/test/test_custom_fields_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_custom_fields_custom_field_gid_body.py` & `asana-4.0.1/test/test_custom_fields_custom_field_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_date_variable_compact.py` & `asana-4.0.1/test/test_date_variable_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_date_variable_request.py` & `asana-4.0.1/test/test_date_variable_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_empty_response.py` & `asana-4.0.1/test/test_empty_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_empty_response_data.py` & `asana-4.0.1/test/test_empty_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_option.py` & `asana-4.0.1/test/test_enum_option.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_option_base.py` & `asana-4.0.1/test/test_enum_option_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_option_data.py` & `asana-4.0.1/test/test_enum_option_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_option_insert_request.py` & `asana-4.0.1/test/test_enum_option_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_option_request.py` & `asana-4.0.1/test/test_enum_option_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_options_enum_option_gid_body.py` & `asana-4.0.1/test/test_enum_options_enum_option_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_enum_options_insert_body.py` & `asana-4.0.1/test/test_enum_options_insert_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_error.py` & `asana-4.0.1/test/test_error.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_error_response.py` & `asana-4.0.1/test/test_error_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_error_response_errors.py` & `asana-4.0.1/test/test_error_response_errors.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response.py` & `asana-4.0.1/test/test_event_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response_array.py` & `asana-4.0.1/test/test_event_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response_change.py` & `asana-4.0.1/test/test_event_response_change.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response_parent.py` & `asana-4.0.1/test/test_event_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response_resource.py` & `asana-4.0.1/test/test_event_response_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_event_response_user.py` & `asana-4.0.1/test/test_event_response_user.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_events_api.py` & `asana-4.0.1/test/test_events_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_add_subgoal_request.py` & `asana-4.0.1/test/test_goal_add_subgoal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_add_supporting_relationship_request.py` & `asana-4.0.1/test/test_goal_add_supporting_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_add_supporting_work_request.py` & `asana-4.0.1/test/test_goal_add_supporting_work_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_base.py` & `asana-4.0.1/test/test_goal_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_compact.py` & `asana-4.0.1/test/test_goal_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_add_followers_body.py` & `asana-4.0.1/test/test_goal_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_add_supporting_relationship_body.py` & `asana-4.0.1/test/test_goal_gid_add_supporting_relationship_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_remove_followers_body.py` & `asana-4.0.1/test/test_goal_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_remove_supporting_relationship_body.py` & `asana-4.0.1/test/test_goal_gid_remove_supporting_relationship_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_set_metric_body.py` & `asana-4.0.1/test/test_goal_gid_set_metric_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_gid_set_metric_current_value_body.py` & `asana-4.0.1/test/test_goal_gid_set_metric_current_value_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_membership_base.py` & `asana-4.0.1/test/test_goal_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_membership_base_goal.py` & `asana-4.0.1/test/test_goal_membership_base_goal.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_membership_compact.py` & `asana-4.0.1/test/test_goal_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_membership_response.py` & `asana-4.0.1/test/test_goal_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_metric_base.py` & `asana-4.0.1/test/test_goal_metric_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_metric_current_value_request.py` & `asana-4.0.1/test/test_goal_metric_current_value_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_metric_request.py` & `asana-4.0.1/test/test_goal_metric_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_base.py` & `asana-4.0.1/test/test_goal_relationship_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_base_supported_goal.py` & `asana-4.0.1/test/test_goal_relationship_base_supported_goal.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_base_supporting_resource.py` & `asana-4.0.1/test/test_goal_relationship_base_supporting_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_compact.py` & `asana-4.0.1/test/test_goal_relationship_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_request.py` & `asana-4.0.1/test/test_goal_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_response.py` & `asana-4.0.1/test/test_goal_relationship_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_response_array.py` & `asana-4.0.1/test/test_goal_relationship_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationship_response_data.py` & `asana-4.0.1/test/test_goal_relationship_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationships_api.py` & `asana-4.0.1/test/test_goal_relationships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_relationships_goal_relationship_gid_body.py` & `asana-4.0.1/test/test_goal_relationships_goal_relationship_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_remove_subgoal_request.py` & `asana-4.0.1/test/test_goal_remove_subgoal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_remove_supporting_relationship_request.py` & `asana-4.0.1/test/test_goal_remove_supporting_relationship_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_request.py` & `asana-4.0.1/test/test_goal_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_request_base.py` & `asana-4.0.1/test/test_goal_request_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response.py` & `asana-4.0.1/test/test_goal_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_array.py` & `asana-4.0.1/test/test_goal_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_current_status_update.py` & `asana-4.0.1/test/test_goal_response_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_data.py` & `asana-4.0.1/test/test_goal_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_likes.py` & `asana-4.0.1/test/test_goal_response_likes.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_metric.py` & `asana-4.0.1/test/test_goal_response_metric.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_team.py` & `asana-4.0.1/test/test_goal_response_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_time_period.py` & `asana-4.0.1/test/test_goal_response_time_period.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_response_workspace.py` & `asana-4.0.1/test/test_goal_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goal_update_request.py` & `asana-4.0.1/test/test_goal_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goals_api.py` & `asana-4.0.1/test/test_goals_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goals_body.py` & `asana-4.0.1/test/test_goals_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_goals_goal_gid_body.py` & `asana-4.0.1/test/test_goals_goal_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_inline_response412.py` & `asana-4.0.1/test/test_inline_response412.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_inline_response412_errors.py` & `asana-4.0.1/test/test_inline_response412_errors.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_base.py` & `asana-4.0.1/test/test_job_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_base_new_project.py` & `asana-4.0.1/test/test_job_base_new_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_base_new_project_template.py` & `asana-4.0.1/test/test_job_base_new_project_template.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_base_new_task.py` & `asana-4.0.1/test/test_job_base_new_task.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_compact.py` & `asana-4.0.1/test/test_job_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_response.py` & `asana-4.0.1/test/test_job_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_job_response_data.py` & `asana-4.0.1/test/test_job_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_jobs_api.py` & `asana-4.0.1/test/test_jobs_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_like.py` & `asana-4.0.1/test/test_like.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_member_compact.py` & `asana-4.0.1/test/test_member_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_membership_request.py` & `asana-4.0.1/test/test_membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_membership_response.py` & `asana-4.0.1/test/test_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_membership_response_array.py` & `asana-4.0.1/test/test_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_membership_response_data.py` & `asana-4.0.1/test/test_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_memberships_api.py` & `asana-4.0.1/test/test_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_memberships_body.py` & `asana-4.0.1/test/test_memberships_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_modify_dependencies_request.py` & `asana-4.0.1/test/test_modify_dependencies_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_modify_dependents_request.py` & `asana-4.0.1/test/test_modify_dependents_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_next_page.py` & `asana-4.0.1/test/test_next_page.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_export_base.py` & `asana-4.0.1/test/test_organization_export_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_export_compact.py` & `asana-4.0.1/test/test_organization_export_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_export_request.py` & `asana-4.0.1/test/test_organization_export_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_export_response.py` & `asana-4.0.1/test/test_organization_export_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_export_response_data.py` & `asana-4.0.1/test/test_organization_export_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_exports_api.py` & `asana-4.0.1/test/test_organization_exports_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_organization_exports_body.py` & `asana-4.0.1/test/test_organization_exports_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_add_item_request.py` & `asana-4.0.1/test/test_portfolio_add_item_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_base.py` & `asana-4.0.1/test/test_portfolio_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_compact.py` & `asana-4.0.1/test/test_portfolio_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_add_custom_field_setting_body.py` & `asana-4.0.1/test/test_portfolio_gid_add_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_add_item_body.py` & `asana-4.0.1/test/test_portfolio_gid_add_item_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_add_members_body.py` & `asana-4.0.1/test/test_portfolio_gid_add_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_remove_custom_field_setting_body.py` & `asana-4.0.1/test/test_portfolio_gid_remove_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_remove_item_body.py` & `asana-4.0.1/test/test_portfolio_gid_remove_item_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_gid_remove_members_body.py` & `asana-4.0.1/test/test_portfolio_gid_remove_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_base.py` & `asana-4.0.1/test/test_portfolio_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_base_portfolio.py` & `asana-4.0.1/test/test_portfolio_membership_base_portfolio.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_compact.py` & `asana-4.0.1/test/test_portfolio_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_response.py` & `asana-4.0.1/test/test_portfolio_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_response_array.py` & `asana-4.0.1/test/test_portfolio_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_membership_response_data.py` & `asana-4.0.1/test/test_portfolio_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_memberships_api.py` & `asana-4.0.1/test/test_portfolio_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_remove_item_request.py` & `asana-4.0.1/test/test_portfolio_remove_item_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_request.py` & `asana-4.0.1/test/test_portfolio_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response.py` & `asana-4.0.1/test/test_portfolio_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_array.py` & `asana-4.0.1/test/test_portfolio_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_current_status_update.py` & `asana-4.0.1/test/test_portfolio_response_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_custom_field_settings.py` & `asana-4.0.1/test/test_portfolio_response_custom_field_settings.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_custom_fields.py` & `asana-4.0.1/test/test_portfolio_response_custom_fields.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_data.py` & `asana-4.0.1/test/test_portfolio_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolio_response_workspace.py` & `asana-4.0.1/test/test_portfolio_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolios_api.py` & `asana-4.0.1/test/test_portfolios_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolios_body.py` & `asana-4.0.1/test/test_portfolios_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_portfolios_portfolio_gid_body.py` & `asana-4.0.1/test/test_portfolios_portfolio_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_preview.py` & `asana-4.0.1/test/test_preview.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_base.py` & `asana-4.0.1/test/test_project_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_base_current_status.py` & `asana-4.0.1/test/test_project_base_current_status.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_base_current_status_update.py` & `asana-4.0.1/test/test_project_base_current_status_update.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_base_workspace.py` & `asana-4.0.1/test/test_project_base_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_base.py` & `asana-4.0.1/test/test_project_brief_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_compact.py` & `asana-4.0.1/test/test_project_brief_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_request.py` & `asana-4.0.1/test/test_project_brief_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_response.py` & `asana-4.0.1/test/test_project_brief_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_response_data.py` & `asana-4.0.1/test/test_project_brief_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_brief_response_project.py` & `asana-4.0.1/test/test_project_brief_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_briefs_api.py` & `asana-4.0.1/test/test_project_briefs_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_briefs_project_brief_gid_body.py` & `asana-4.0.1/test/test_project_briefs_project_brief_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_compact.py` & `asana-4.0.1/test/test_project_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_duplicate_request.py` & `asana-4.0.1/test/test_project_duplicate_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_duplicate_request_schedule_dates.py` & `asana-4.0.1/test/test_project_duplicate_request_schedule_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_add_custom_field_setting_body.py` & `asana-4.0.1/test/test_project_gid_add_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_add_followers_body.py` & `asana-4.0.1/test/test_project_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_add_members_body.py` & `asana-4.0.1/test/test_project_gid_add_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_duplicate_body.py` & `asana-4.0.1/test/test_project_gid_duplicate_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_project_briefs_body.py` & `asana-4.0.1/test/test_project_gid_project_briefs_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_project_statuses_body.py` & `asana-4.0.1/test/test_project_gid_project_statuses_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_remove_custom_field_setting_body.py` & `asana-4.0.1/test/test_project_gid_remove_custom_field_setting_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_remove_followers_body.py` & `asana-4.0.1/test/test_project_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_remove_members_body.py` & `asana-4.0.1/test/test_project_gid_remove_members_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_save_as_template_body.py` & `asana-4.0.1/test/test_project_gid_save_as_template_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_gid_sections_body.py` & `asana-4.0.1/test/test_project_gid_sections_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_base.py` & `asana-4.0.1/test/test_project_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_compact.py` & `asana-4.0.1/test/test_project_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_response.py` & `asana-4.0.1/test/test_project_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_response_array.py` & `asana-4.0.1/test/test_project_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_response_data.py` & `asana-4.0.1/test/test_project_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_membership_response_member.py` & `asana-4.0.1/test/test_project_membership_response_member.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_memberships_api.py` & `asana-4.0.1/test/test_project_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_request.py` & `asana-4.0.1/test/test_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response.py` & `asana-4.0.1/test/test_project_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_array.py` & `asana-4.0.1/test/test_project_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_completed_by.py` & `asana-4.0.1/test/test_project_response_completed_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_created_from_template.py` & `asana-4.0.1/test/test_project_response_created_from_template.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_data.py` & `asana-4.0.1/test/test_project_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_project_brief.py` & `asana-4.0.1/test/test_project_response_project_brief.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_response_team.py` & `asana-4.0.1/test/test_project_response_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_save_as_template_request.py` & `asana-4.0.1/test/test_project_save_as_template_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_section_insert_request.py` & `asana-4.0.1/test/test_project_section_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_base.py` & `asana-4.0.1/test/test_project_status_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_compact.py` & `asana-4.0.1/test/test_project_status_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_request.py` & `asana-4.0.1/test/test_project_status_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_response.py` & `asana-4.0.1/test/test_project_status_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_response_array.py` & `asana-4.0.1/test/test_project_status_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_status_response_data.py` & `asana-4.0.1/test/test_project_status_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_statuses_api.py` & `asana-4.0.1/test/test_project_statuses_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_base.py` & `asana-4.0.1/test/test_project_template_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_base_requested_dates.py` & `asana-4.0.1/test/test_project_template_base_requested_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_base_requested_roles.py` & `asana-4.0.1/test/test_project_template_base_requested_roles.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_base_team.py` & `asana-4.0.1/test/test_project_template_base_team.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_compact.py` & `asana-4.0.1/test/test_project_template_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_gid_instantiate_project_body.py` & `asana-4.0.1/test/test_project_template_gid_instantiate_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_instantiate_project_request.py` & `asana-4.0.1/test/test_project_template_instantiate_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_instantiate_project_request_requested_dates.py` & `asana-4.0.1/test/test_project_template_instantiate_project_request_requested_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_instantiate_project_request_requested_roles.py` & `asana-4.0.1/test/test_project_template_instantiate_project_request_requested_roles.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_response.py` & `asana-4.0.1/test/test_project_template_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_response_array.py` & `asana-4.0.1/test/test_project_template_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_template_response_data.py` & `asana-4.0.1/test/test_project_template_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_project_templates_api.py` & `asana-4.0.1/test/test_project_templates_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_projects_api.py` & `asana-4.0.1/test/test_projects_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_projects_body.py` & `asana-4.0.1/test/test_projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_projects_project_gid_body.py` & `asana-4.0.1/test/test_projects_project_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_remove_custom_field_setting_request.py` & `asana-4.0.1/test/test_remove_custom_field_setting_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_remove_followers_request.py` & `asana-4.0.1/test/test_remove_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_remove_members_request.py` & `asana-4.0.1/test/test_remove_members_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_requested_role_request.py` & `asana-4.0.1/test/test_requested_role_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_rule_trigger_gid_run_body.py` & `asana-4.0.1/test/test_rule_trigger_gid_run_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_rule_trigger_request.py` & `asana-4.0.1/test/test_rule_trigger_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_rule_trigger_response.py` & `asana-4.0.1/test/test_rule_trigger_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_rule_trigger_response_data.py` & `asana-4.0.1/test/test_rule_trigger_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_rules_api.py` & `asana-4.0.1/test/test_rules_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_base.py` & `asana-4.0.1/test/test_section_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_compact.py` & `asana-4.0.1/test/test_section_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_gid_add_task_body.py` & `asana-4.0.1/test/test_section_gid_add_task_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_request.py` & `asana-4.0.1/test/test_section_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_response.py` & `asana-4.0.1/test/test_section_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_response_array.py` & `asana-4.0.1/test/test_section_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_response_data.py` & `asana-4.0.1/test/test_section_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_section_task_insert_request.py` & `asana-4.0.1/test/test_section_task_insert_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_sections_api.py` & `asana-4.0.1/test/test_sections_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_sections_insert_body.py` & `asana-4.0.1/test/test_sections_insert_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_sections_section_gid_body.py` & `asana-4.0.1/test/test_sections_section_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_base.py` & `asana-4.0.1/test/test_status_update_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_compact.py` & `asana-4.0.1/test/test_status_update_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_request.py` & `asana-4.0.1/test/test_status_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_response.py` & `asana-4.0.1/test/test_status_update_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_response_array.py` & `asana-4.0.1/test/test_status_update_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_response_data.py` & `asana-4.0.1/test/test_status_update_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_update_response_parent.py` & `asana-4.0.1/test/test_status_update_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_updates_api.py` & `asana-4.0.1/test/test_status_updates_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_status_updates_body.py` & `asana-4.0.1/test/test_status_updates_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_stories_api.py` & `asana-4.0.1/test/test_stories_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_stories_story_gid_body.py` & `asana-4.0.1/test/test_stories_story_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_base.py` & `asana-4.0.1/test/test_story_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_compact.py` & `asana-4.0.1/test/test_story_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_request.py` & `asana-4.0.1/test/test_story_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response.py` & `asana-4.0.1/test/test_story_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_array.py` & `asana-4.0.1/test/test_story_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_assignee.py` & `asana-4.0.1/test/test_story_response_assignee.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_custom_field.py` & `asana-4.0.1/test/test_story_response_custom_field.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_data.py` & `asana-4.0.1/test/test_story_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_dates.py` & `asana-4.0.1/test/test_story_response_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_old_dates.py` & `asana-4.0.1/test/test_story_response_old_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_old_enum_value.py` & `asana-4.0.1/test/test_story_response_old_enum_value.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_old_section.py` & `asana-4.0.1/test/test_story_response_old_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_previews.py` & `asana-4.0.1/test/test_story_response_previews.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_project.py` & `asana-4.0.1/test/test_story_response_project.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_story.py` & `asana-4.0.1/test/test_story_response_story.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_tag.py` & `asana-4.0.1/test/test_story_response_tag.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_target.py` & `asana-4.0.1/test/test_story_response_target.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_story_response_task.py` & `asana-4.0.1/test/test_story_response_task.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_base.py` & `asana-4.0.1/test/test_tag_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_compact.py` & `asana-4.0.1/test/test_tag_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_request.py` & `asana-4.0.1/test/test_tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_response.py` & `asana-4.0.1/test/test_tag_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_response_array.py` & `asana-4.0.1/test/test_tag_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tag_response_data.py` & `asana-4.0.1/test/test_tag_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tags_api.py` & `asana-4.0.1/test/test_tags_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tags_body.py` & `asana-4.0.1/test/test_tags_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_add_followers_request.py` & `asana-4.0.1/test/test_task_add_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_add_project_request.py` & `asana-4.0.1/test/test_task_add_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_add_tag_request.py` & `asana-4.0.1/test/test_task_add_tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base.py` & `asana-4.0.1/test/test_task_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base_completed_by.py` & `asana-4.0.1/test/test_task_base_completed_by.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base_dependencies.py` & `asana-4.0.1/test/test_task_base_dependencies.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base_external.py` & `asana-4.0.1/test/test_task_base_external.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base_memberships.py` & `asana-4.0.1/test/test_task_base_memberships.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_base_section.py` & `asana-4.0.1/test/test_task_base_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_compact.py` & `asana-4.0.1/test/test_task_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_count_response.py` & `asana-4.0.1/test/test_task_count_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_count_response_data.py` & `asana-4.0.1/test/test_task_count_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_duplicate_request.py` & `asana-4.0.1/test/test_task_duplicate_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_add_dependencies_body.py` & `asana-4.0.1/test/test_task_gid_add_dependencies_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_add_dependents_body.py` & `asana-4.0.1/test/test_task_gid_add_dependents_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_add_followers_body.py` & `asana-4.0.1/test/test_task_gid_add_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_add_project_body.py` & `asana-4.0.1/test/test_task_gid_add_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_add_tag_body.py` & `asana-4.0.1/test/test_task_gid_add_tag_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_duplicate_body.py` & `asana-4.0.1/test/test_task_gid_duplicate_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_remove_dependencies_body.py` & `asana-4.0.1/test/test_task_gid_remove_dependencies_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_remove_dependents_body.py` & `asana-4.0.1/test/test_task_gid_remove_dependents_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_remove_followers_body.py` & `asana-4.0.1/test/test_task_gid_remove_followers_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_remove_project_body.py` & `asana-4.0.1/test/test_task_gid_remove_project_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_remove_tag_body.py` & `asana-4.0.1/test/test_task_gid_remove_tag_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_set_parent_body.py` & `asana-4.0.1/test/test_task_gid_set_parent_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_stories_body.py` & `asana-4.0.1/test/test_task_gid_stories_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_subtasks_body.py` & `asana-4.0.1/test/test_task_gid_subtasks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_gid_time_tracking_entries_body.py` & `asana-4.0.1/test/test_task_gid_time_tracking_entries_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_remove_followers_request.py` & `asana-4.0.1/test/test_task_remove_followers_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_remove_project_request.py` & `asana-4.0.1/test/test_task_remove_project_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_remove_tag_request.py` & `asana-4.0.1/test/test_task_remove_tag_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_request.py` & `asana-4.0.1/test/test_task_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response.py` & `asana-4.0.1/test/test_task_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_array.py` & `asana-4.0.1/test/test_task_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_assignee_section.py` & `asana-4.0.1/test/test_task_response_assignee_section.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_custom_fields.py` & `asana-4.0.1/test/test_task_response_custom_fields.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_data.py` & `asana-4.0.1/test/test_task_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_parent.py` & `asana-4.0.1/test/test_task_response_parent.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_tags.py` & `asana-4.0.1/test/test_task_response_tags.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_response_workspace.py` & `asana-4.0.1/test/test_task_response_workspace.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_task_set_parent_request.py` & `asana-4.0.1/test/test_task_set_parent_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tasks_api.py` & `asana-4.0.1/test/test_tasks_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tasks_body.py` & `asana-4.0.1/test/test_tasks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_tasks_task_gid_body.py` & `asana-4.0.1/test/test_tasks_task_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_add_user_request.py` & `asana-4.0.1/test/test_team_add_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_base.py` & `asana-4.0.1/test/test_team_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_compact.py` & `asana-4.0.1/test/test_team_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_gid_add_user_body.py` & `asana-4.0.1/test/test_team_gid_add_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_gid_projects_body.py` & `asana-4.0.1/test/test_team_gid_projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_gid_remove_user_body.py` & `asana-4.0.1/test/test_team_gid_remove_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_membership_base.py` & `asana-4.0.1/test/test_team_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_membership_compact.py` & `asana-4.0.1/test/test_team_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_membership_response.py` & `asana-4.0.1/test/test_team_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_membership_response_array.py` & `asana-4.0.1/test/test_team_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_membership_response_data.py` & `asana-4.0.1/test/test_team_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_memberships_api.py` & `asana-4.0.1/test/test_team_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_remove_user_request.py` & `asana-4.0.1/test/test_team_remove_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_request.py` & `asana-4.0.1/test/test_team_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_response.py` & `asana-4.0.1/test/test_team_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_response_array.py` & `asana-4.0.1/test/test_team_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_response_data.py` & `asana-4.0.1/test/test_team_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_team_response_organization.py` & `asana-4.0.1/test/test_team_response_organization.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_teams_api.py` & `asana-4.0.1/test/test_teams_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_teams_body.py` & `asana-4.0.1/test/test_teams_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_teams_team_gid_body.py` & `asana-4.0.1/test/test_teams_team_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_template_role.py` & `asana-4.0.1/test/test_template_role.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_period_base.py` & `asana-4.0.1/test/test_time_period_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_period_compact.py` & `asana-4.0.1/test/test_time_period_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_period_response.py` & `asana-4.0.1/test/test_time_period_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_period_response_array.py` & `asana-4.0.1/test/test_time_period_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_period_response_data.py` & `asana-4.0.1/test/test_time_period_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_periods_api.py` & `asana-4.0.1/test/test_time_periods_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entries_api.py` & `asana-4.0.1/test/test_time_tracking_entries_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entries_time_tracking_entry_gid_body.py` & `asana-4.0.1/test/test_time_tracking_entries_time_tracking_entry_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entry_base.py` & `asana-4.0.1/test/test_time_tracking_entry_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entry_base_data.py` & `asana-4.0.1/test/test_time_tracking_entry_base_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entry_compact.py` & `asana-4.0.1/test/test_time_tracking_entry_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_time_tracking_entry_compact_array.py` & `asana-4.0.1/test/test_time_tracking_entry_compact_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_typeahead_api.py` & `asana-4.0.1/test/test_typeahead_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_update_time_tracking_entry_request.py` & `asana-4.0.1/test/test_update_time_tracking_entry_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_base.py` & `asana-4.0.1/test/test_user_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_base_response.py` & `asana-4.0.1/test/test_user_base_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_base_response_data.py` & `asana-4.0.1/test/test_user_base_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_base_response_photo.py` & `asana-4.0.1/test/test_user_base_response_photo.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_compact.py` & `asana-4.0.1/test/test_user_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_request.py` & `asana-4.0.1/test/test_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_response.py` & `asana-4.0.1/test/test_user_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_response_array.py` & `asana-4.0.1/test/test_user_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_response_data.py` & `asana-4.0.1/test/test_user_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_list_base.py` & `asana-4.0.1/test/test_user_task_list_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_list_compact.py` & `asana-4.0.1/test/test_user_task_list_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_list_request.py` & `asana-4.0.1/test/test_user_task_list_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_list_response.py` & `asana-4.0.1/test/test_user_task_list_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_list_response_data.py` & `asana-4.0.1/test/test_user_task_list_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_user_task_lists_api.py` & `asana-4.0.1/test/test_user_task_lists_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_users_api.py` & `asana-4.0.1/test/test_users_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_compact.py` & `asana-4.0.1/test/test_webhook_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_compact_resource.py` & `asana-4.0.1/test/test_webhook_compact_resource.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_filter.py` & `asana-4.0.1/test/test_webhook_filter.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_request.py` & `asana-4.0.1/test/test_webhook_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_request_filters.py` & `asana-4.0.1/test/test_webhook_request_filters.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_response.py` & `asana-4.0.1/test/test_webhook_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_response_array.py` & `asana-4.0.1/test/test_webhook_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_response_data.py` & `asana-4.0.1/test/test_webhook_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhook_update_request.py` & `asana-4.0.1/test/test_webhook_update_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhooks_api.py` & `asana-4.0.1/test/test_webhooks_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhooks_body.py` & `asana-4.0.1/test/test_webhooks_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_webhooks_webhook_gid_body.py` & `asana-4.0.1/test/test_webhooks_webhook_gid_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_add_user_request.py` & `asana-4.0.1/test/test_workspace_add_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_base.py` & `asana-4.0.1/test/test_workspace_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_compact.py` & `asana-4.0.1/test/test_workspace_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_gid_add_user_body.py` & `asana-4.0.1/test/test_workspace_gid_add_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_gid_projects_body.py` & `asana-4.0.1/test/test_workspace_gid_projects_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_gid_remove_user_body.py` & `asana-4.0.1/test/test_workspace_gid_remove_user_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_gid_tags_body.py` & `asana-4.0.1/test/test_workspace_gid_tags_body.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_base.py` & `asana-4.0.1/test/test_workspace_membership_base.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_compact.py` & `asana-4.0.1/test/test_workspace_membership_compact.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_request.py` & `asana-4.0.1/test/test_workspace_membership_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_response.py` & `asana-4.0.1/test/test_workspace_membership_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_response_array.py` & `asana-4.0.1/test/test_workspace_membership_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_response_data.py` & `asana-4.0.1/test/test_workspace_membership_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_response_user_task_list.py` & `asana-4.0.1/test/test_workspace_membership_response_user_task_list.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_membership_response_vacation_dates.py` & `asana-4.0.1/test/test_workspace_membership_response_vacation_dates.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_memberships_api.py` & `asana-4.0.1/test/test_workspace_memberships_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_remove_user_request.py` & `asana-4.0.1/test/test_workspace_remove_user_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_request.py` & `asana-4.0.1/test/test_workspace_request.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_response.py` & `asana-4.0.1/test/test_workspace_response.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_response_array.py` & `asana-4.0.1/test/test_workspace_response_array.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspace_response_data.py` & `asana-4.0.1/test/test_workspace_response_data.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspaces_api.py` & `asana-4.0.1/test/test_workspaces_api.py`

 * *Files identical despite different names*

### Comparing `asana-4.0.0/test/test_workspaces_workspace_gid_body.py` & `asana-4.0.1/test/test_workspaces_workspace_gid_body.py`
