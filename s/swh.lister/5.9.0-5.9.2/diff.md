# Comparing `tmp/swh.lister-5.9.0.tar.gz` & `tmp/swh.lister-5.9.2.tar.gz`
...
### Comparing `swh.lister-5.9.0/.pre-commit-config.yaml` & `swh.lister-5.9.2/.pre-commit-config.yaml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/CODE_OF_CONDUCT.md` & `swh.lister-5.9.2/CODE_OF_CONDUCT.md`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/LICENSE` & `swh.lister-5.9.2/LICENSE`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/PKG-INFO` & `swh.lister-5.9.2/PKG-INFO`
...
### Comparing `swh.lister-5.9.0/README.md` & `swh.lister-5.9.2/README.md`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/conftest.py` & `swh.lister-5.9.2/conftest.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/images/new_base.png` & `swh.lister-5.9.2/docs/images/new_base.png`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/images/new_bitbucket_lister.png` & `swh.lister-5.9.2/docs/images/new_bitbucket_lister.png`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/images/new_github_lister.png` & `swh.lister-5.9.2/docs/images/new_github_lister.png`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/images/old_github_lister.png` & `swh.lister-5.9.2/docs/images/old_github_lister.png`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/index.rst` & `swh.lister-5.9.2/docs/index.rst`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/new_lister_template.py` & `swh.lister-5.9.2/docs/new_lister_template.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/run_a_new_lister.rst` & `swh.lister-5.9.2/docs/run_a_new_lister.rst`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/save_forge.rst` & `swh.lister-5.9.2/docs/save_forge.rst`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/docs/tutorial.rst` & `swh.lister-5.9.2/docs/tutorial.rst`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/mypy.ini` & `swh.lister-5.9.2/mypy.ini`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/setup.py` & `swh.lister-5.9.2/setup.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/sql/crawler.sql` & `swh.lister-5.9.2/sql/crawler.sql`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/sql/pimp_db.sql` & `swh.lister-5.9.2/sql/pimp_db.sql`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/__init__.py` & `swh.lister-5.9.2/swh/lister/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/__init__.py` & `swh.lister-5.9.2/swh/lister/arch/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/lister.py` & `swh.lister-5.9.2/swh/lister/arch/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tasks.py` & `swh.lister-5.9.2/swh/lister/arch/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/__init__.py` & `swh.lister-5.9.2/swh/lister/arch/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/fake_archlinux_archives_init.sh` & `swh.lister-5.9.2/swh/lister/arch/tests/data/fake_archlinux_archives_init.sh`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_d_dialog` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_d_dialog`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_g_gnome-code-assistance` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_g_gnome-code-assistance`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_g_gzip` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_g_gzip`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_l_libasyncns` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_l_libasyncns`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_m_mercurial` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_m_mercurial`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_p_python-hglib` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/packages_p_python-hglib`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_community_os_x86_64_community.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_community_os_x86_64_community.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_core_os_x86_64_core.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_core_os_x86_64_core.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_extra_os_x86_64_extra.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_archive.archlinux.org/repos_last_extra_os_x86_64_extra.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_community_community.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_community_community.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_core_core.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_core_core.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_extra_extra.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/aarch64_extra_extra.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_community_community.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_community_community.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_core_core.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_core_core.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_extra_extra.files.tar.gz` & `swh.lister-5.9.2/swh/lister/arch/tests/data/https_uk.mirror.archlinuxarm.org/armv7h_extra_extra.files.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/arch/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/arch/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/arch/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/__init__.py` & `swh.lister-5.9.2/swh/lister/aur/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/lister.py` & `swh.lister-5.9.2/swh/lister/aur/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/tasks.py` & `swh.lister-5.9.2/swh/lister/aur/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/tests/data/fake_aur_packages.sh` & `swh.lister-5.9.2/swh/lister/aur/tests/data/fake_aur_packages.sh`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/tests/data/packages-meta-v1.json.gz` & `swh.lister-5.9.2/swh/lister/aur/tests/data/packages-meta-v1.json.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/aur/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/aur/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/aur/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/lister.py` & `swh.lister-5.9.2/swh/lister/bitbucket/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/tasks.py` & `swh.lister-5.9.2/swh/lister/bitbucket/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/tests/data/bb_api_repositories_page1.json` & `swh.lister-5.9.2/swh/lister/bitbucket/tests/data/bb_api_repositories_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/tests/data/bb_api_repositories_page2.json` & `swh.lister-5.9.2/swh/lister/bitbucket/tests/data/bb_api_repositories_page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/bitbucket/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bitbucket/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/bitbucket/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bower/__init__.py` & `swh.lister-5.9.2/swh/lister/bower/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bower/lister.py` & `swh.lister-5.9.2/swh/lister/bower/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bower/tasks.py` & `swh.lister-5.9.2/swh/lister/bower/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bower/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/bower/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/bower/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/bower/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/lister.py` & `swh.lister-5.9.2/swh/lister/cgit/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tasks.py` & `swh.lister-5.9.2/swh/lister/cgit/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.acdw.net/cgit` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.acdw.net/cgit`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.acdw.net/foo` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.acdw.net/foo`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.acdw.net/foo_summary` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.acdw.net/foo_summary`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.acdw.net/sfeed` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.acdw.net/sfeed`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.acdw.net/sfeed_summary` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.acdw.net/sfeed_summary`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.baserock.org/cgit` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.baserock.org/cgit`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.eclipse.org/c` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.eclipse.org/c`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.savannah.gnu.org/cgit` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.savannah.gnu.org/cgit`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.savannah.gnu.org/cgit_elisp-es.git` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.savannah.gnu.org/cgit_elisp-es.git`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit,ofs=100` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit,ofs=100`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit,ofs=50` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit,ofs=50`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_All-Projects` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_All-Projects`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_All-Users` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_All-Users`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_Lock-Projects` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_Lock-Projects`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_alsa-scenario-scn-data-0-base` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_alsa-scenario-scn-data-0-base`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_alsa-scenario-scn-data-0-mc1n2` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_alsa-scenario-scn-data-0-mc1n2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_ap_samsung_audio-hal-e3250` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_ap_samsung_audio-hal-e3250`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_ap_samsung_audio-hal-e4x12` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_ap_samsung_audio-hal-e4x12`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_devices_nfc-plugin-nxp` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_devices_nfc-plugin-nxp`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_intel_mfld_bootstub-mfld-blackbay` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_intel_mfld_bootstub-mfld-blackbay`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_mtdev` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_mtdev`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_opengl-es-virtual-drv` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_opengl-es-virtual-drv`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_panda_libdrm` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_panda_libdrm`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_panda_libnl` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_panda_libnl`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_xorg_driver_xserver-xorg-misc` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_adaptation_xorg_driver_xserver-xorg-misc`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_apps_core_preloaded_ug-setting-gallery-efl` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_apps_core_preloaded_ug-setting-gallery-efl`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_git.tizen/cgit_apps_core_preloaded_ug-setting-homescreen-efl` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_git.tizen/cgit_apps_core_preloaded_ug-setting-homescreen-efl`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/data/https_jff.email/cgit` & `swh.lister-5.9.2/swh/lister/cgit/tests/data/https_jff.email/cgit`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/repo_list.txt` & `swh.lister-5.9.2/swh/lister/cgit/tests/repo_list.txt`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/cgit/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cgit/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/cgit/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cli.py` & `swh.lister-5.9.2/swh/lister/cli.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/__init__.py` & `swh.lister-5.9.2/swh/lister/conda/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/lister.py` & `swh.lister-5.9.2/swh/lister/conda/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tasks.py` & `swh.lister-5.9.2/swh/lister/conda/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_conda.anaconda.org/conda-forge_linux-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_conda.anaconda.org/conda-forge_linux-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_linux-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_linux-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_osx-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_osx-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_win-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_free_win-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_main_linux-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_main_linux-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_pro_linux-64_repodata.json.bz2` & `swh.lister-5.9.2/swh/lister/conda/tests/data/https_repo.anaconda.com/pkgs_pro_linux-64_repodata.json.bz2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/conda/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/conda/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/conda/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/__init__.py` & `swh.lister-5.9.2/swh/lister/cpan/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/lister.py` & `swh.lister-5.9.2/swh/lister/cpan/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tasks.py` & `swh.lister-5.9.2/swh/lister/cpan/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page1` & `swh.lister-5.9.2/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page2` & `swh.lister-5.9.2/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page3` & `swh.lister-5.9.2/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page3`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page4` & `swh.lister-5.9.2/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1__search_scroll_page4`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1_release__search` & `swh.lister-5.9.2/swh/lister/cpan/tests/data/https_fastapi.metacpan.org/v1_release__search`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/cpan/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cpan/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/cpan/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cran/lister.py` & `swh.lister-5.9.2/swh/lister/cran/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cran/tasks.py` & `swh.lister-5.9.2/swh/lister/cran/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cran/tests/data/list-r-packages.json` & `swh.lister-5.9.2/swh/lister/cran/tests/data/list-r-packages.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cran/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/cran/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/cran/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/cran/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/__init__.py` & `swh.lister-5.9.2/swh/lister/crates/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/lister.py` & `swh.lister-5.9.2/swh/lister/crates/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tasks.py` & `swh.lister-5.9.2/swh/lister/crates/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tests/data/fake_crates_repository_init.sh` & `swh.lister-5.9.2/swh/lister/crates/tests/data/fake_crates_repository_init.sh`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tests/data/https_static.crates.io/db-dump.tar.gz` & `swh.lister-5.9.2/swh/lister/crates/tests/data/https_static.crates.io/db-dump.tar.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tests/data/https_static.crates.io/db-dump.tar.gz_visit1` & `swh.lister-5.9.2/swh/lister/crates/tests/data/https_static.crates.io/db-dump.tar.gz_visit1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/crates/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/crates/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/crates/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/lister.py` & `swh.lister-5.9.2/swh/lister/debian/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tasks.py` & `swh.lister-5.9.2/swh/lister/debian/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tests/data/Sources_bullseye` & `swh.lister-5.9.2/swh/lister/debian/tests/data/Sources_bullseye`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tests/data/Sources_buster` & `swh.lister-5.9.2/swh/lister/debian/tests/data/Sources_buster`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tests/data/Sources_stretch` & `swh.lister-5.9.2/swh/lister/debian/tests/data/Sources_stretch`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/debian/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/debian/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/debian/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/lister.py` & `swh.lister-5.9.2/swh/lister/fedora/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tasks.py` & `swh.lister-5.9.2/swh/lister/fedora/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary26.xml.gz` & `swh.lister-5.9.2/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary26.xml.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary36-altered.xml.gz` & `swh.lister-5.9.2/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary36-altered.xml.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary36.xml.gz` & `swh.lister-5.9.2/swh/lister/fedora/tests/data/archives.fedoraproject.org/primary36.xml.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/data/archives.fedoraproject.org/repomd26.xml` & `swh.lister-5.9.2/swh/lister/fedora/tests/data/archives.fedoraproject.org/repomd26.xml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/data/archives.fedoraproject.org/repomd36.xml` & `swh.lister-5.9.2/swh/lister/fedora/tests/data/archives.fedoraproject.org/repomd36.xml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/fedora/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/fedora/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/fedora/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/lister.py` & `swh.lister-5.9.2/swh/lister/gitea/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/tasks.py` & `swh.lister-5.9.2/swh/lister/gitea/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/tests/data/https_try.gitea.io/repos_page1` & `swh.lister-5.9.2/swh/lister/gitea/tests/data/https_try.gitea.io/repos_page1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/tests/data/https_try.gitea.io/repos_page2` & `swh.lister-5.9.2/swh/lister/gitea/tests/data/https_try.gitea.io/repos_page2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gitea/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitea/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gitea/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/github/lister.py` & `swh.lister-5.9.2/swh/lister/github/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/github/tasks.py` & `swh.lister-5.9.2/swh/lister/github/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/github/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/github/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/github/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/github/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitiles/lister.py` & `swh.lister-5.9.2/swh/lister/gitiles/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitiles/tests/data/https_android.googlesource.com/,format=json` & `swh.lister-5.9.2/swh/lister/gitiles/tests/data/https_android.googlesource.com/,format=json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitiles/tests/data/https_gerrit.googlesource.com/,format=json` & `swh.lister-5.9.2/swh/lister/gitiles/tests/data/https_gerrit.googlesource.com/,format=json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitiles/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gitiles/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitiles/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gitiles/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/lister.py` & `swh.lister-5.9.2/swh/lister/gitlab/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tasks.py` & `swh.lister-5.9.2/swh/lister/gitlab/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/data/https_foss.heptapod.net/api_response_page1.json` & `swh.lister-5.9.2/swh/lister/gitlab/tests/data/https_foss.heptapod.net/api_response_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page1.json` & `swh.lister-5.9.2/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page2.json` & `swh.lister-5.9.2/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page3.json` & `swh.lister-5.9.2/swh/lister/gitlab/tests/data/https_gite.lirmm.fr/api_response_page3.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/data/https_gitlab.com/api_response_page1.json` & `swh.lister-5.9.2/swh/lister/gitlab/tests/data/https_gitlab.com/api_response_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gitlab/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitlab/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gitlab/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/lister.py` & `swh.lister-5.9.2/swh/lister/gitweb/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/foobar` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/foobar`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_doc_ips` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_doc_ips`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_firewall` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_firewall`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_mdwtools` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_mdwtools`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_scad` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_scad`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_strayman` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_strayman`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_udpkey` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_udpkey`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_vmctl` & `swh.lister-5.9.2/swh/lister/gitweb/tests/data/https_git.distorted.org.uk/~mdw_vmctl`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gitweb/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gitweb/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gitweb/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/lister.py` & `swh.lister-5.9.2/swh/lister/gnu/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tasks.py` & `swh.lister-5.9.2/swh/lister/gnu/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/data/https_ftp.gnu.org/tree.json.gz` & `swh.lister-5.9.2/swh/lister/gnu/tests/data/https_ftp.gnu.org/tree.json.gz`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/data/tree.json` & `swh.lister-5.9.2/swh/lister/gnu/tests/data/tree.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/data/tree.min.json` & `swh.lister-5.9.2/swh/lister/gnu/tests/data/tree.min.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gnu/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gnu/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tests/test_tree.py` & `swh.lister-5.9.2/swh/lister/gnu/tests/test_tree.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gnu/tree.py` & `swh.lister-5.9.2/swh/lister/gnu/tree.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/lister.py` & `swh.lister-5.9.2/swh/lister/gogs/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tasks.py` & `swh.lister-5.9.2/swh/lister/gogs/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page1` & `swh.lister-5.9.2/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page2` & `swh.lister-5.9.2/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page3` & `swh.lister-5.9.2/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page3`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page4` & `swh.lister-5.9.2/swh/lister/gogs/tests/data/https_try.gogs.io/repos_page4`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/gogs/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/gogs/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/gogs/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/golang/lister.py` & `swh.lister-5.9.2/swh/lister/golang/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/golang/tasks.py` & `swh.lister-5.9.2/swh/lister/golang/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/golang/tests/data/page-3.txt` & `swh.lister-5.9.2/swh/lister/golang/tests/data/page-3.txt`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/golang/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/golang/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/golang/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/golang/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/__init__.py` & `swh.lister-5.9.2/swh/lister/hackage/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/lister.py` & `swh.lister-5.9.2/swh/lister/hackage/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tasks.py` & `swh.lister-5.9.2/swh/lister/hackage/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_fake49.haskell.org/packages_search_0` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_fake49.haskell.org/packages_search_0`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_fake51.haskell.org/packages_search_0` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_fake51.haskell.org/packages_search_0`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_fake51.haskell.org/packages_search_1` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_fake51.haskell.org/packages_search_1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_0` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_0`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_0_visit1` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_0_visit1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_1` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_2` & `swh.lister-5.9.2/swh/lister/hackage/tests/data/https_hackage.haskell.org/packages_search_2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/hackage/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hackage/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/hackage/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/lister.py` & `swh.lister-5.9.2/swh/lister/hex/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tasks.py` & `swh.lister-5.9.2/swh/lister/hex/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tests/data/https_hex.pm/page1.json` & `swh.lister-5.9.2/swh/lister/hex/tests/data/https_hex.pm/page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tests/data/https_hex.pm/page2.json` & `swh.lister-5.9.2/swh/lister/hex/tests/data/https_hex.pm/page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tests/data/https_hex.pm/page3.json` & `swh.lister-5.9.2/swh/lister/hex/tests/data/https_hex.pm/page3.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/hex/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/hex/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/hex/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/lister.py` & `swh.lister-5.9.2/swh/lister/launchpad/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tasks.py` & `swh.lister-5.9.2/swh/lister/launchpad/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/conftest.py` & `swh.lister-5.9.2/swh/lister/launchpad/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/data/launchpad_bzr_response.json` & `swh.lister-5.9.2/swh/lister/launchpad/tests/data/launchpad_bzr_response.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/data/launchpad_response1.json` & `swh.lister-5.9.2/swh/lister/launchpad/tests/data/launchpad_response1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/data/launchpad_response2.json` & `swh.lister-5.9.2/swh/lister/launchpad/tests/data/launchpad_response2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/launchpad/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/launchpad/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/launchpad/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/README.md` & `swh.lister-5.9.2/swh/lister/maven/README.md`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/lister.py` & `swh.lister-5.9.2/swh/lister/maven/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tasks.py` & `swh.lister-5.9.2/swh/lister/maven/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/citrus-parent-3.0.7.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/citrus-parent-3.0.7.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/http_indexes/export_full.fld` & `swh.lister-5.9.2/swh/lister/maven/tests/data/http_indexes/export_full.fld`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/http_indexes/export_incr_first.fld` & `swh.lister-5.9.2/swh/lister/maven/tests/data/http_indexes/export_incr_first.fld`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_api.github.com/repos_aldialimucaj_sprova4j` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_api.github.com/repos_aldialimucaj_sprova4j`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_api.github.com/repos_arangodb-community_arangodb-graphql-java` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_api.github.com/repos_arangodb-community_arangodb-graphql-java`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_api.github.com/repos_webx_citrus` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_api.github.com/repos_webx_citrus`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_al_aldi_sprova4j_0.1.0_sprova4j-0.1.0.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_al_aldi_sprova4j_0.1.0_sprova4j-0.1.0.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_al_aldi_sprova4j_0.1.1_sprova4j-0.1.1.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_al_aldi_sprova4j_0.1.1_sprova4j-0.1.1.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_com_arangodb_arangodb-graphql_1.2_arangodb-graphql-1.2.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/https_repo1.maven.org/maven2_com_arangodb_arangodb-graphql_1.2_arangodb-graphql-1.2.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/sprova4j-0.1.0.invalidurl.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/sprova4j-0.1.0.invalidurl.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/data/sprova4j-0.1.0.malformed.pom` & `swh.lister-5.9.2/swh/lister/maven/tests/data/sprova4j-0.1.0.malformed.pom`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/maven/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/maven/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/maven/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/__init__.py` & `swh.lister-5.9.2/swh/lister/nixguix/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/lister.py` & `swh.lister-5.9.2/swh/lister/nixguix/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/tasks.py` & `swh.lister-5.9.2/swh/lister/nixguix/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/tests/data/sources-failure.json` & `swh.lister-5.9.2/swh/lister/nixguix/tests/data/sources-failure.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/tests/data/sources-success.json` & `swh.lister-5.9.2/swh/lister/nixguix/tests/data/sources-success.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/nixguix/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nixguix/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/nixguix/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/__init__.py` & `swh.lister-5.9.2/swh/lister/npm/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/lister.py` & `swh.lister-5.9.2/swh/lister/npm/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tasks.py` & `swh.lister-5.9.2/swh/lister/npm/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/data/npm_full_page1.json` & `swh.lister-5.9.2/swh/lister/npm/tests/data/npm_full_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/data/npm_full_page2.json` & `swh.lister-5.9.2/swh/lister/npm/tests/data/npm_full_page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/data/npm_incremental_page1.json` & `swh.lister-5.9.2/swh/lister/npm/tests/data/npm_incremental_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/data/npm_incremental_page2.json` & `swh.lister-5.9.2/swh/lister/npm/tests/data/npm_incremental_page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/npm/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/npm/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/npm/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/__init__.py` & `swh.lister-5.9.2/swh/lister/nuget/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/lister.py` & `swh.lister-5.9.2/swh/lister/nuget/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tasks.py` & `swh.lister-5.9.2/swh/lister/nuget/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_intersoft.crosslight.logging.entityframework_5.0.5000.1235-experimental_intersoft.crosslight.logging.entityframework.nuspec` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_intersoft.crosslight.logging.entityframework_5.0.5000.1235-experimental_intersoft.crosslight.logging.entityframework.nuspec`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_moq.automock_3.5.0-ci0287_moq.automock.nuspec` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_moq.automock_3.5.0-ci0287_moq.automock.nuspec`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_sil.core.desktop_10.0.1-beta0012_sil.core.desktop.nuspec` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3-flatcontainer_sil.core.desktop_10.0.1-beta0012_sil.core.desktop.nuspec`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.09.23.08.07.54_sil.core.desktop.10.0.1-beta0012.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.09.23.08.07.54_sil.core.desktop.10.0.1-beta0012.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.09.23.09.10.26_intersoft.crosslight.logging.entityframework.5.0.5000.1235-experimental.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.09.23.09.10.26_intersoft.crosslight.logging.entityframework.5.0.5000.1235-experimental.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.10.10.04.04.00_moq.automock.3.5.0-ci0287.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_data_2022.10.10.04.04.00_moq.automock.3.5.0-ci0287.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_index.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_index.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_index.json_visit1` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_index.json_visit1`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page11702.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page11702.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page16958.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page16958.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page17100.json` & `swh.lister-5.9.2/swh/lister/nuget/tests/data/https_api.nuget.org/v3_catalog0_page17100.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/nuget/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/nuget/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/nuget/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/lister.py` & `swh.lister-5.9.2/swh/lister/opam/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tasks.py` & `swh.lister-5.9.2/swh/lister/opam/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/agrid/agrid.0.1/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/agrid/agrid.0.1/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.1/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.1/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.2/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.2/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.3/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.3/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.4/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.4/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.5/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.5/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.6/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/calculon/calculon.0.6/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.1/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.1/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.2/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.2/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.3/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/directories/directories.0.3/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/data/fake_opam_repo/packages/ocb/ocb.0.1/opam` & `swh.lister-5.9.2/swh/lister/opam/tests/data/fake_opam_repo/packages/ocb/ocb.0.1/opam`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/opam/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/opam/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/opam/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/lister.py` & `swh.lister-5.9.2/swh/lister/packagist/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tasks.py` & `swh.lister-5.9.2/swh/lister/packagist/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/den1n_contextmenu.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/den1n_contextmenu.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/https_api.github.com/repos_spryker-eco_computop-api` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/https_api.github.com/repos_spryker-eco_computop-api`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/https_api.github.com/repos_ycms_module-main` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/https_api.github.com/repos_ycms_module-main`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/idevlab_essential.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/idevlab_essential.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/ljjackson_linnworks.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/ljjackson_linnworks.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/lky_wx_article.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/lky_wx_article.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/payrix_payrix-php.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/payrix_payrix-php.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/spryker-eco_computop-api.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/spryker-eco_computop-api.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/with_invalid_url.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/with_invalid_url.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/data/ycms_module-main.json` & `swh.lister-5.9.2/swh/lister/packagist/tests/data/ycms_module-main.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/packagist/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/packagist/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/packagist/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/lister.py` & `swh.lister-5.9.2/swh/lister/pagure/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/tasks.py` & `swh.lister-5.9.2/swh/lister/pagure/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/tests/data/https_pagure.io/api_0_projects,per_page=2` & `swh.lister-5.9.2/swh/lister/pagure/tests/data/https_pagure.io/api_0_projects,per_page=2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/tests/data/https_pagure.io/api_0_projects,per_page=2,page=2` & `swh.lister-5.9.2/swh/lister/pagure/tests/data/https_pagure.io/api_0_projects,per_page=2,page=2`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/pagure/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pagure/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/pagure/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pattern.py` & `swh.lister-5.9.2/swh/lister/pattern.py`
...
### Comparing `swh.lister-5.9.0/swh/lister/phabricator/lister.py` & `swh.lister-5.9.2/swh/lister/phabricator/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/phabricator/tasks.py` & `swh.lister-5.9.2/swh/lister/phabricator/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/phabricator/tests/data/phabricator_api_repositories_page1.json` & `swh.lister-5.9.2/swh/lister/phabricator/tests/data/phabricator_api_repositories_page1.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/phabricator/tests/data/phabricator_api_repositories_page2.json` & `swh.lister-5.9.2/swh/lister/phabricator/tests/data/phabricator_api_repositories_page2.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/phabricator/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/phabricator/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/phabricator/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/phabricator/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/__init__.py` & `swh.lister-5.9.2/swh/lister/pubdev/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/lister.py` & `swh.lister-5.9.2/swh/lister/pubdev/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/tasks.py` & `swh.lister-5.9.2/swh/lister/pubdev/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/tests/data/https_pub.dev/api_packages_Autolinker` & `swh.lister-5.9.2/swh/lister/pubdev/tests/data/https_pub.dev/api_packages_Autolinker`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/tests/data/https_pub.dev/api_packages_Babylon` & `swh.lister-5.9.2/swh/lister/pubdev/tests/data/https_pub.dev/api_packages_Babylon`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/pubdev/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pubdev/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/pubdev/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/__init__.py` & `swh.lister-5.9.2/swh/lister/puppet/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/lister.py` & `swh.lister-5.9.2/swh/lister/puppet/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tasks.py` & `swh.lister-5.9.2/swh/lister/puppet/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100` & `swh.lister-5.9.2/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100,offset=100` & `swh.lister-5.9.2/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100,offset=100`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100,with_release_since=2022-09-26` & `swh.lister-5.9.2/swh/lister/puppet/tests/data/https_forgeapi.puppet.com/v3_modules,limit=100,with_release_since=2022-09-26`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/puppet/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/puppet/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/puppet/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pypi/lister.py` & `swh.lister-5.9.2/swh/lister/pypi/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pypi/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/pypi/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/pypi/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/pypi/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/__init__.py` & `swh.lister-5.9.2/swh/lister/rubygems/__init__.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/lister.py` & `swh.lister-5.9.2/swh/lister/rubygems/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tasks.py` & `swh.lister-5.9.2/swh/lister/rubygems/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tests/data/rubygems_dumps.xml` & `swh.lister-5.9.2/swh/lister/rubygems/tests/data/rubygems_dumps.xml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tests/data/rubygems_pgsql_dump.tar` & `swh.lister-5.9.2/swh/lister/rubygems/tests/data/rubygems_pgsql_dump.tar`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tests/data/small_rubygems_dump.sh` & `swh.lister-5.9.2/swh/lister/rubygems/tests/data/small_rubygems_dump.sh`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/rubygems/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/rubygems/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/rubygems/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/lister.py` & `swh.lister-5.9.2/swh/lister/sourceforge/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tasks.py` & `swh.lister-5.9.2/swh/lister/sourceforge/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/aaron.html` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/aaron.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/aaron.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/aaron.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/adobexmp.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/adobexmp.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/backapps-website.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/backapps-website.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/backapps.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/backapps.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/mojunk.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/mojunk.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/mramm.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/mramm.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/ocaml-lpd.html` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/ocaml-lpd.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/ocaml-lpd.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/ocaml-lpd.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/os3dmodels.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/os3dmodels.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/random-mercurial.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/random-mercurial.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/subsitemap-0.xml` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/subsitemap-0.xml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/subsitemap-1.xml` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/subsitemap-1.xml`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/t12eksandbox.html` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/t12eksandbox.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/data/t12eksandbox.json` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/data/t12eksandbox.json`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/sourceforge/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/sourceforge/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/lister.py` & `swh.lister-5.9.2/swh/lister/stagit/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/foobar` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/foobar`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/foobar_bmf_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/foobar_bmf_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/foobar_dmenu_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/foobar_dmenu_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/foobar_dwm_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/foobar_dwm_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/foobar_stagit_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/foobar_stagit_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/git` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/git`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/git_bmf_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/git_bmf_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/git_dmenu_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/git_dmenu_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/git_dwm_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/git_dwm_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/data/https_codemadness.org/git_stagit_log.html` & `swh.lister-5.9.2/swh/lister/stagit/tests/data/https_codemadness.org/git_stagit_log.html`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/stagit/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/stagit/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/stagit/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tests/test_cli.py` & `swh.lister-5.9.2/swh/lister/tests/test_cli.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tests/test_pattern.py` & `swh.lister-5.9.2/swh/lister/tests/test_pattern.py`
...
### Comparing `swh.lister-5.9.0/swh/lister/tests/test_utils.py` & `swh.lister-5.9.2/swh/lister/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tuleap/lister.py` & `swh.lister-5.9.2/swh/lister/tuleap/lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tuleap/tasks.py` & `swh.lister-5.9.2/swh/lister/tuleap/tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tuleap/tests/data/https_tuleap.net/projects` & `swh.lister-5.9.2/swh/lister/tuleap/tests/data/https_tuleap.net/projects`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tuleap/tests/test_lister.py` & `swh.lister-5.9.2/swh/lister/tuleap/tests/test_lister.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/tuleap/tests/test_tasks.py` & `swh.lister-5.9.2/swh/lister/tuleap/tests/test_tasks.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh/lister/utils.py` & `swh.lister-5.9.2/swh/lister/utils.py`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh.lister.egg-info/PKG-INFO` & `swh.lister-5.9.2/swh.lister.egg-info/PKG-INFO`
...
### Comparing `swh.lister-5.9.0/swh.lister.egg-info/SOURCES.txt` & `swh.lister-5.9.2/swh.lister.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/swh.lister.egg-info/entry_points.txt` & `swh.lister-5.9.2/swh.lister.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `swh.lister-5.9.0/tox.ini` & `swh.lister-5.9.2/tox.ini`
