# Comparing `tmp/templaterepo-0.1.1.tar.gz` & `tmp/templaterepo-0.1.2.tar.gz`
...
## Comparing `templaterepo-0.1.1.tar` & `templaterepo-0.1.2.tar`
...
### Comparing `templaterepo-0.1.1/LICENSE.txt` & `templaterepo-0.1.2/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `templaterepo-0.1.1/pyproject.toml` & `templaterepo-0.1.2/pyproject.toml`

 * *Files identical despite different names*

### Comparing `templaterepo-0.1.1/setup.py` & `templaterepo-0.1.2/setup.py`
