# Comparing `tmp/tencentcloud-sdk-python-waf-3.0.946.tar.gz` & `tmp/tencentcloud-sdk-python-waf-3.0.947.tar.gz`
...
## Comparing `tencentcloud-sdk-python-waf-3.0.946.tar` & `tencentcloud-sdk-python-waf-3.0.947.tar`
...
### Comparing `tencentcloud-sdk-python-waf-3.0.946/setup.py` & `tencentcloud-sdk-python-waf-3.0.947/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-waf-3.0.946/tencentcloud/__init__.py` & `tencentcloud-sdk-python-waf-3.0.947/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-waf-3.0.946/tencentcloud/waf/v20180125/errorcodes.py` & `tencentcloud-sdk-python-waf-3.0.947/tencentcloud/waf/v20180125/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-waf-3.0.946/tencentcloud/waf/v20180125/waf_client.py` & `tencentcloud-sdk-python-waf-3.0.947/tencentcloud/waf/v20180125/waf_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-waf-3.0.946/tencentcloud/waf/v20180125/models.py` & `tencentcloud-sdk-python-waf-3.0.947/tencentcloud/waf/v20180125/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-waf-3.0.946/PKG-INFO` & `tencentcloud-sdk-python-waf-3.0.947/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-waf-3.0.946/tencentcloud_sdk_python_waf.egg-info/PKG-INFO` & `tencentcloud-sdk-python-waf-3.0.947/tencentcloud_sdk_python_waf.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-waf-3.0.946/README.rst` & `tencentcloud-sdk-python-waf-3.0.947/README.rst`
