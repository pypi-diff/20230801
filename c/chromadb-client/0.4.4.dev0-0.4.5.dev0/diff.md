# Comparing `tmp/chromadb-client-0.4.4.dev0.tar.gz` & `tmp/chromadb-client-0.4.5.dev0.tar.gz`
...
### Comparing `chromadb-client-0.4.4.dev0/.github/ISSUE_TEMPLATE/bug_report.yaml` & `chromadb-client-0.4.5.dev0/.github/ISSUE_TEMPLATE/bug_report.yaml`
...
### Comparing `chromadb-client-0.4.4.dev0/README.md` & `chromadb-client-0.4.5.dev0/README.md`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/api/segment.py` & `chromadb-client-0.4.5.dev0/chromadb/api/segment.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/api/types.py` & `chromadb-client-0.4.5.dev0/chromadb/api/types.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/config.py` & `chromadb-client-0.4.5.dev0/chromadb/config.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/__init__.py` & `chromadb-client-0.4.5.dev0/chromadb/db/__init__.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/base.py` & `chromadb-client-0.4.5.dev0/chromadb/db/base.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/impl/sqlite.py` & `chromadb-client-0.4.5.dev0/chromadb/db/impl/sqlite.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/impl/sqlite_pool.py` & `chromadb-client-0.4.5.dev0/chromadb/db/impl/sqlite_pool.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/migrations.py` & `chromadb-client-0.4.5.dev0/chromadb/db/migrations.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/mixins/embeddings_queue.py` & `chromadb-client-0.4.5.dev0/chromadb/db/mixins/embeddings_queue.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/mixins/sysdb.py` & `chromadb-client-0.4.5.dev0/chromadb/db/mixins/sysdb.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/db/system.py` & `chromadb-client-0.4.5.dev0/chromadb/db/system.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/errors.py` & `chromadb-client-0.4.5.dev0/chromadb/errors.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/experimental/density_relevance.ipynb` & `chromadb-client-0.4.5.dev0/chromadb/experimental/density_relevance.ipynb`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/ingest/__init__.py` & `chromadb-client-0.4.5.dev0/chromadb/ingest/__init__.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/migrations/metadb/00001-embedding-metadata.sqlite.sql` & `chromadb-client-0.4.5.dev0/chromadb/migrations/metadb/00001-embedding-metadata.sqlite.sql`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/__init__.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/__init__.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/manager/local.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/manager/local.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/metadata/sqlite.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/metadata/sqlite.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/vector/batch.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/vector/batch.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/vector/brute_force_index.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/vector/brute_force_index.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/vector/hnsw_params.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/vector/hnsw_params.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/vector/local_hnsw.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/vector/local_hnsw.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/segment/impl/vector/local_persistent_hnsw.py` & `chromadb-client-0.4.5.dev0/chromadb/segment/impl/vector/local_persistent_hnsw.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/server/fastapi/__init__.py` & `chromadb-client-0.4.5.dev0/chromadb/server/fastapi/__init__.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/server/fastapi/types.py` & `chromadb-client-0.4.5.dev0/chromadb/server/fastapi/types.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/telemetry/__init__.py` & `chromadb-client-0.4.5.dev0/chromadb/telemetry/__init__.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/telemetry/events.py` & `chromadb-client-0.4.5.dev0/chromadb/telemetry/events.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/telemetry/posthog.py` & `chromadb-client-0.4.5.dev0/chromadb/telemetry/posthog.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/conftest.py` & `chromadb-client-0.4.5.dev0/chromadb/test/conftest.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/db/test_base.py` & `chromadb-client-0.4.5.dev0/chromadb/test/db/test_base.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/db/test_migrations.py` & `chromadb-client-0.4.5.dev0/chromadb/test/db/test_migrations.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/db/test_system.py` & `chromadb-client-0.4.5.dev0/chromadb/test/db/test_system.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/ingest/test_producer_consumer.py` & `chromadb-client-0.4.5.dev0/chromadb/test/ingest/test_producer_consumer.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/invariants.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/invariants.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/strategies.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/strategies.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_add.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_add.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_collections.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_collections.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_cross_version_persist.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_cross_version_persist.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_embeddings.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_embeddings.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_filtering.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_filtering.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/property/test_persist.py` & `chromadb-client-0.4.5.dev0/chromadb/test/property/test_persist.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/segment/test_metadata.py` & `chromadb-client-0.4.5.dev0/chromadb/test/segment/test_metadata.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/segment/test_vector.py` & `chromadb-client-0.4.5.dev0/chromadb/test/segment/test_vector.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/test_api.py` & `chromadb-client-0.4.5.dev0/chromadb/test/test_api.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/test_chroma.py` & `chromadb-client-0.4.5.dev0/chromadb/test/test_chroma.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/test_client.py` & `chromadb-client-0.4.5.dev0/chromadb/test/test_client.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/test_config.py` & `chromadb-client-0.4.5.dev0/chromadb/test/test_config.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/test_multithreaded.py` & `chromadb-client-0.4.5.dev0/chromadb/test/test_multithreaded.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/test/utils/test_messagid.py` & `chromadb-client-0.4.5.dev0/chromadb/test/utils/test_messagid.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/types.py` & `chromadb-client-0.4.5.dev0/chromadb/types.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/utils/distance_functions.py` & `chromadb-client-0.4.5.dev0/chromadb/utils/distance_functions.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/utils/embedding_functions.py` & `chromadb-client-0.4.5.dev0/chromadb/utils/embedding_functions.py`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb/utils/messageid.py` & `chromadb-client-0.4.5.dev0/chromadb/utils/messageid.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb/utils/read_write_lock.py` & `chromadb-client-0.4.5.dev0/chromadb/utils/read_write_lock.py`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/chromadb_client.egg-info/PKG-INFO` & `chromadb-client-0.4.5.dev0/chromadb_client.egg-info/PKG-INFO`
...
### Comparing `chromadb-client-0.4.4.dev0/chromadb_client.egg-info/SOURCES.txt` & `chromadb-client-0.4.5.dev0/chromadb_client.egg-info/SOURCES.txt`
...
### Comparing `chromadb-client-0.4.4.dev0/clients/js/DEVELOP.md` & `chromadb-client-0.4.5.dev0/clients/js/DEVELOP.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/LICENSE` & `chromadb-client-0.4.5.dev0/clients/js/LICENSE`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/README.md` & `chromadb-client-0.4.5.dev0/clients/js/README.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/examples/browser/app.ts` & `chromadb-client-0.4.5.dev0/clients/js/examples/browser/app.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/examples/browser/index.html` & `chromadb-client-0.4.5.dev0/clients/js/examples/browser/index.html`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/examples/browser/yarn.lock` & `chromadb-client-0.4.5.dev0/clients/js/examples/browser/yarn.lock`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/examples/node/app.js` & `chromadb-client-0.4.5.dev0/clients/js/examples/node/app.js`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/examples/node/yarn.lock` & `chromadb-client-0.4.5.dev0/clients/js/examples/node/yarn.lock`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/genapi.sh` & `chromadb-client-0.4.5.dev0/clients/js/genapi.sh`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/package-lock.json` & `chromadb-client-0.4.5.dev0/clients/js/package-lock.json`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/package.json` & `chromadb-client-0.4.5.dev0/clients/js/package.json`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/ChromaClient.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/ChromaClient.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/Collection.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/Collection.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/embeddings/CohereEmbeddingFunction.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/embeddings/CohereEmbeddingFunction.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/embeddings/OpenAIEmbeddingFunction.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/embeddings/OpenAIEmbeddingFunction.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/embeddings/TransformersEmbeddingFunction.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/embeddings/TransformersEmbeddingFunction.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/embeddings/WebAIEmbeddingFunction.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/embeddings/WebAIEmbeddingFunction.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/generated/README.md` & `chromadb-client-0.4.5.dev0/clients/js/src/generated/README.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/generated/api.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/generated/api.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/generated/configuration.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/generated/configuration.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/generated/models.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/generated/models.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/generated/runtime.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/generated/runtime.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/types.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/types.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/src/utils.ts` & `chromadb-client-0.4.5.dev0/clients/js/src/utils.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/add.collections.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/add.collections.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/client.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/client.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/collection.client.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/collection.client.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/delete.collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/delete.collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/get.collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/get.collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/peek.collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/peek.collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/query.collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/query.collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/update.collection.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/update.collection.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/test/upsert.collections.test.ts` & `chromadb-client-0.4.5.dev0/clients/js/test/upsert.collections.test.ts`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/js/yarn.lock` & `chromadb-client-0.4.5.dev0/clients/js/yarn.lock`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/python/README.md` & `chromadb-client-0.4.5.dev0/clients/python/README.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/python/build_python_thin_client.sh` & `chromadb-client-0.4.5.dev0/clients/python/build_python_thin_client.sh`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/python/integration-test.sh` & `chromadb-client-0.4.5.dev0/clients/python/integration-test.sh`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/clients/python/pyproject.toml` & `chromadb-client-0.4.5.dev0/clients/python/pyproject.toml`
...
### Comparing `chromadb-client-0.4.4.dev0/docker-compose.test.yml` & `chromadb-client-0.4.5.dev0/docker-compose.test.yml`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/README.md` & `chromadb-client-0.4.5.dev0/examples/README.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/basic_functionality/alternative_embeddings.ipynb` & `chromadb-client-0.4.5.dev0/examples/basic_functionality/alternative_embeddings.ipynb`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/basic_functionality/local_persistence.ipynb` & `chromadb-client-0.4.5.dev0/examples/basic_functionality/local_persistence.ipynb`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/basic_functionality/where_filtering.ipynb` & `chromadb-client-0.4.5.dev0/examples/basic_functionality/where_filtering.ipynb`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/deployments/google-cloud-compute/README.md` & `chromadb-client-0.4.5.dev0/examples/deployments/google-cloud-compute/README.md`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/deployments/google-cloud-compute/chroma.tf` & `chromadb-client-0.4.5.dev0/examples/deployments/google-cloud-compute/chroma.tf`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/deployments/google-cloud-compute/startup.sh` & `chromadb-client-0.4.5.dev0/examples/deployments/google-cloud-compute/startup.sh`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/use_with/cohere/cohere_js.js` & `chromadb-client-0.4.5.dev0/examples/use_with/cohere/cohere_js.js`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/examples/use_with/cohere/cohere_python.ipynb` & `chromadb-client-0.4.5.dev0/examples/use_with/cohere/cohere_python.ipynb`

 * *Files identical despite different names*

### Comparing `chromadb-client-0.4.4.dev0/pyproject.toml` & `chromadb-client-0.4.5.dev0/pyproject.toml`
