# Comparing `tmp/mypy-boto3-support-app-1.28.15.post1.tar.gz` & `tmp/mypy-boto3-support-app-1.28.16.tar.gz`
...
### Comparing `mypy-boto3-support-app-1.28.15.post1/LICENSE` & `mypy-boto3-support-app-1.28.16/LICENSE`
